...
import io.agora.scene.grandchorus.databinding.GrandchorusActivityRoomListBinding
import io.agora.scene.grandchorus.databinding.GrandchorusItemRoomListBinding
import io.agora.scene.grandchorus.service.GrandChorusServiceProtocol
import io.agora.scene.grandchorus.service.JoinRoomOutputModel
import io.agora.scene.grandchorus.service.RoomListModel
import io.agora.scene.grandchorus.ui.holder.RoomHolder
...
class RoomListActivity : BaseViewBindingActivity<GrandchorusActivityRoomListBinding>() {

    private val roomCreateViewModel by lazy {
        ViewModelProvider(this)[RoomCreateViewModel::class.java]
    }

    private var mAdapter: BaseRecyclerViewAdapter<GrandchorusItemRoomListBinding, RoomListModel, RoomHolder>? = null

    private var isJoining = false

    private var inputPasswordDialog: InputPasswordDialog? = null

    override fun getViewBinding(inflater: LayoutInflater): GrandchorusActivityRoomListBinding {
        return GrandchorusActivityRoomListBinding.inflate(inflater)
    }
