package io.agora.scene.voice.spatial.ui.widget.expression;
...
public class ExpressionView extends LinearLayoutCompat {
   ...
   public void init(int Columns){
      ...
      View view = LayoutInflater.from(context).inflate(R.layout.voice_spatial_widget_expression_gridview, this);
