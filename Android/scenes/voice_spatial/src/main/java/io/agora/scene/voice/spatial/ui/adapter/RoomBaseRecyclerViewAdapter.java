...
import io.agora.scene.voice.spatial.ui.adapter.listener.OnAdapterItemClickListener;
import io.agora.scene.voice.spatial.ui.adapter.listener.OnItemLongClickListener;
...
public abstract class RoomBaseRecyclerViewAdapter<T> extends RecyclerView.Adapter<RoomBaseRecyclerViewAdapter.ViewHolder<T>> {
    ...
    protected ViewHolder<T> getEmptyViewHolder(ViewGroup parent) {
        ...
        if (hideEmptyView) {
            emptyView = LayoutInflater.from(mContext).inflate(R.layout.voice_spatial_layout_no_data_show_nothing, parent, false);
        }
    ...
    public int getEmptyLayoutId() {
        return R.layout.voice_spatial_layout_no_data_show_nothing;
    }
