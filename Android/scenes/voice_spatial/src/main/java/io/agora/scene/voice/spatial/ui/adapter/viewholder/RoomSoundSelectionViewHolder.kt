...
import io.agora.scene.voice.spatial.databinding.VoiceSpatialItemSoundSelectionFooterBinding
...
class RoomSoundSelectionViewHolder(binding: VoiceSpatialItemRoomSoundSelectionBinding) :
    BaseRecyclerViewAdapter.BaseViewHolder<VoiceSpatialItemRoomSoundSelectionBinding, SoundSelectionBean>(binding) {
...
class RoomSoundSelectionFooterViewHolder(binding: VoiceSpatialItemSoundSelectionFooterBinding) :
    BaseRecyclerViewAdapter.BaseViewHolder<VoiceSpatialItemSoundSelectionFooterBinding, String>(binding) {
