...
object ConfigConstants {
    ...
    //--------AI Noise Suppression Mode start--------
    object AINSMode {
        const val AINS_High = 0 // High
        const val AINS_Medium = 1 // Medium
        const val AINS_Off = 2  // Off
        const val AINS_Unknown = -1 // Unknown
    ...
    //--------AI Noise Suppression Mode end--------

    //--------Robot Speaker Type start--------
    object BotSpeaker {
        const val None = -1 // None
        const val BotBlue = 0 // Robot Blue
        const val BotRed = 1 // Robot Red
        const val BotBoth = 2 // Both robots playing together
    }
    //--------Robot Speaker Type end--------

    //--------Volume Level start--------
    object VolumeType {
        const val Volume_None = 0 // No volume
        const val Volume_Low = 1 // Low volume
        const val Volume_Medium = 2 // Medium volume
        const val Volume_High = 3 // High volume
        const val Volume_Max = 4 // Maximum volume
    }
    //--------Volume Level end--------

    //--------AI Noise Suppression Sound Types start--------
    object AINSSoundType {
        ...
        const val AINS_MicPopFilterSound = 11 // Microphone pop filter noise
        const val AINS_AudioFeedback = 12 // Audio feedback
        const val AINS_MicrophoneFingerRub = 13 // Finger rubbing microphone while holding phone
        const val AINS_MicrophoneScreenTap = 14 // Screen tapping noise while holding phone
    }
    //--------AI Noise Suppression Sound Types end--------
