...
class RoomEncryptionInputDialog constructor() : BaseFragmentDialog<VoiceSpatialDialogEncryptionBinding>() {
    ...
    override fun getViewBinding(inflater: LayoutInflater, container: ViewGroup?): VoiceSpatialDialogEncryptionBinding? {
        return VoiceSpatialDialogEncryptionBinding.inflate(inflater, container, false)
    }
