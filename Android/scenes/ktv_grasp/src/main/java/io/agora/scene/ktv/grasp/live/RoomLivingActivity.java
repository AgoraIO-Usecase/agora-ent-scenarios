package io.agora.scene.ktv.grasp.live;
...
import io.agora.scene.ktv.grasp.KTVLogger;
import io.agora.scene.base.utils.ToastUtils;
import io.agora.scene.ktv.grasp.R;
import io.agora.scene.ktv.grasp.databinding.KtvActivityRoomLivingBinding;
import io.agora.scene.ktv.grasp.databinding.KtvItemRoomSpeakerBinding;
import io.agora.scene.ktv.grasp.debugSettings.KTVDebugSettingsDialog;
import io.agora.scene.ktv.grasp.live.fragment.dialog.MVFragment;
import io.agora.scene.ktv.grasp.live.listener.LrcActionListenerImpl;
import io.agora.scene.ktv.grasp.live.listener.SongActionListenerImpl;
import io.agora.scene.ktv.grasp.service.JoinRoomOutputModel;
import io.agora.scene.ktv.grasp.service.RoomSeatModel;
import io.agora.scene.ktv.grasp.service.RoomSelSongModel;
import io.agora.scene.ktv.grasp.widget.KtvCommonDialog;
import io.agora.scene.ktv.grasp.widget.lrcView.LrcControlView;
import io.agora.scene.ktv.grasp.widget.MoreDialog;
import io.agora.scene.ktv.grasp.widget.MusicSettingDialog;
import io.agora.scene.ktv.grasp.widget.UserLeaveSeatMenuDialog;
import io.agora.scene.ktv.grasp.widget.song.SongDialog;
