...
import io.agora.scene.ktv.singrelay.databinding.KtvRelayActivityRoomListBinding;
 ...
 * 房间列表
 */
public class RoomListActivity extends BaseViewBindingActivity<KtvRelayActivityRoomListBinding> {
    ...
    @Override
    protected KtvRelayActivityRoomListBinding getViewBinding(@NonNull LayoutInflater inflater) {
        return KtvRelayActivityRoomListBinding.inflate(inflater);
    }
    ...
    private class RoomListAdapter extends RecyclerView.Adapter<RoomListAdapter.ViewHolder> {
        ...
        public RoomListAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(mContext).inflate(R.layout.ktv_relay_item_room_list, parent, false);
