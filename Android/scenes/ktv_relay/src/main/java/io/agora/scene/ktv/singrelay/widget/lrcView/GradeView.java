...
public class GradeView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            colorOfBackground = getResources().getColor(R.color.ktv_relay_grade_view_bg, null);
            colorOfContentGray = getResources().getColor(R.color.ktv_relay_grade_view_content_gray, null);
        } else {
            colorOfBackground = getResources().getColor(R.color.ktv_relay_grade_view_bg);
            colorOfContentGray = getResources().getColor(R.color.ktv_relay_grade_view_content_gray);
        }
