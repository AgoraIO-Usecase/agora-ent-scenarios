...
//            toast.setMargin(0, 0);
            View rootView = LayoutInflater.from(context).inflate(R.layout.joy_view_toast_custom, null);
            ...
            if (toastType == COMMON) {
                ...
                if (toastType == TIPS) {
                    imageView.setImageResource(R.drawable.joy_icon_right);
                } else {
                    imageView.setImageResource(R.drawable.joy_icon_wrong);
                }
            }
