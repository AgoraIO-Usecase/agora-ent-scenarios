...
import io.agora.scene.voice.spatial.databinding.VoiceSpatialActivitySoundSelectionLayoutBinding
import io.agora.scene.voice.spatial.global.VoiceConfigManager.getLifecycleCallbacks
import io.agora.scene.voice.spatial.model.SoundSelectionBean
import io.agora.scene.voice.spatial.model.VoiceRoomModel
import io.agora.scene.voice.spatial.model.constructor.RoomSoundSelectionConstructor.builderSoundSelectionList
import io.agora.scene.voice.spatial.service.VoiceServiceProtocol
import io.agora.scene.voice.spatial.ui.adapter.VoiceRoomSoundSelectionAdapter
...
class VoiceRoomSoundSelectionActivity : BaseUiActivity<VoiceSpatialActivitySoundSelectionLayoutBinding>() {
    ...
    override fun getViewBinding(inflater: LayoutInflater): VoiceSpatialActivitySoundSelectionLayoutBinding {
        return VoiceSpatialActivitySoundSelectionLayoutBinding.inflate(inflater)
    }
