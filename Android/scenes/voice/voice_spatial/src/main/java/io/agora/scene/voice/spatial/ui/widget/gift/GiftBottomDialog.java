...
import io.agora.scene.voice.spatial.databinding.VoiceSpatialDialogGiftLayoutBinding;
import io.agora.scene.voice.spatial.databinding.VoiceSpatialPopGiftLayoutBinding;
...
public class GiftBottomDialog extends BaseSheetDialog<VoiceSpatialDialogGiftLayoutBinding> implements View.OnClickListener {
    ...
    private VoiceSpatialDialogGiftLayoutBinding binding;
    ...
    @Nullable
    @Override
    protected VoiceSpatialDialogGiftLayoutBinding getViewBinding(@NonNull LayoutInflater inflater, @Nullable ViewGroup container) {
        return VoiceSpatialDialogGiftLayoutBinding.inflate(inflater, container, false);
    }
    ...
    private void showPop(View itemView) {
        ...
        if (getContext() != null) {
            new CommonPopupWindow.ViewDataBindingBuilder<VoiceSpatialPopGiftLayoutBinding>()
                    .viewDataBinding(VoiceSpatialPopGiftLayoutBinding.inflate(LayoutInflater.from(getContext())))
