...
import io.agora.scene.voice.spatial.ui.adapter.Room2DMicAdapter
import io.agora.scene.voice.spatial.ui.adapter.viewholder.Room2DBotMicViewHolder
import io.agora.scene.voice.spatial.ui.adapter.viewholder.Room2DMicViewHolder
...
class Room2DMicLayout : ConstraintLayout, IRoomMicView {
    ...
    private lateinit var binding: VoiceSpatialViewRoom2dMicLayoutBinding
    ...
    private fun init(context: Context) {
        val root = View.inflate(context, R.layout.voice_spatial_view_room_2d_mic_layout, this)
        binding = VoiceSpatialViewRoom2dMicLayoutBinding.bind(root)
    }
    ...
    fun setUpInitAdapter() {
        ...
        binding.rvChatroomMicLayout.apply {
            ...
            addItemDecoration(MaterialDividerItemDecoration(context, MaterialDividerItemDecoration.VERTICAL).apply {
                ...
                dividerColor = ResourcesTools.getColor(context.resources, io.agora.voice.common.R.color.voice_transparent)
            })
