...
import io.agora.scene.voice.spatial.databinding.VoiceSpatialDialogChatroomAinsBinding
import io.agora.scene.voice.spatial.databinding.VoiceSpatialItemRoomAgoraAinsBinding
import io.agora.scene.voice.spatial.databinding.VoiceSpatialItemRoomAinsAuditionBinding
import io.agora.scene.voice.spatial.model.AINSModeBean
import io.agora.scene.voice.spatial.model.AINSSoundsBean
import io.agora.scene.voice.spatial.model.constructor.RoomAINSConstructor
import io.agora.scene.voice.spatial.ui.adapter.viewholder.*
...
class RoomAINSSheetDialog constructor() : BaseFixedHeightSheetDialog<VoiceSpatialDialogChatroomAinsBinding>() {
    ...
    private var anisModeAdapter: BaseRecyclerViewAdapter<VoiceSpatialItemRoomAgoraAinsBinding, AINSModeBean, RoomAINSModeViewHolder>? =
        null
    private var anisSoundsAdapter: BaseRecyclerViewAdapter<VoiceSpatialItemRoomAinsAuditionBinding, AINSSoundsBean, RoomAINSSoundsViewHolder>? =
        null
    ...
    override fun getViewBinding(
        ...
        container: ViewGroup?
    ): VoiceSpatialDialogChatroomAinsBinding {
        return VoiceSpatialDialogChatroomAinsBinding.inflate(inflater, container, false)
    }
