 ...
 * 中间弹框，确认/取消按钮
 */
class CommonFragmentAlertDialog constructor() : BaseFragmentDialog<VoiceSpatialDialogCenterFragmentAlertBinding>() {

    override fun getViewBinding(inflater: LayoutInflater, container: ViewGroup?): VoiceSpatialDialogCenterFragmentAlertBinding {
        return VoiceSpatialDialogCenterFragmentAlertBinding.inflate(inflater, container, false)
    }
