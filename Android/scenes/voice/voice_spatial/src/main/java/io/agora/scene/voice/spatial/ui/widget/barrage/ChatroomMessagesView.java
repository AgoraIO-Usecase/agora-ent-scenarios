package io.agora.scene.voice.spatial.ui.widget.barrage;
...
import io.agora.scene.voice.spatial.imkit.bean.ChatMessageData;
import io.agora.scene.voice.spatial.imkit.custorm.CustomMsgHelper;
import io.agora.scene.voice.spatial.imkit.custorm.CustomMsgType;
import io.agora.scene.voice.spatial.imkit.manager.ChatroomIMManager;
...
public class ChatroomMessagesView extends RelativeLayout{
    ...
    private void init(Context context, AttributeSet attrs){
        ...
        LayoutInflater.from(context).inflate(R.layout.voice_spatial_widget_room_messages, this);
    ...
    private class ListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            if (viewType == ITEM_DEFAULT_TYPE){
                return new MyViewHolder(LayoutInflater.from(context).inflate(R.layout.voice_spatial_widget_barrage_msgs_item, parent, false));
            }else if (viewType == ITEM_SYSTEM_TYPE){
                return new SystemViewHolder(LayoutInflater.from(context).inflate(R.layout.voice_spatial_widget_barrage_system_msgs_item, parent, false));
            }
            return new MyViewHolder(LayoutInflater.from(context).inflate(R.layout.voice_spatial_widget_barrage_msgs_item, parent, false));
        }
