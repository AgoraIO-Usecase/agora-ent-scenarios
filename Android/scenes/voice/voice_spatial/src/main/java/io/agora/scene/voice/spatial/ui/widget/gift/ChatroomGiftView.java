...
public class ChatroomGiftView extends LinearLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.voice_spatial_widget_gift_layout, this);
    ...
    private class GiftListAdapter extends RecyclerView.Adapter<GiftViewHolder> {
        ...
        public GiftViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            return new GiftViewHolder(LayoutInflater.from(context).inflate(R.layout.voice_spatial_widget_gift_item, parent, false));
        }
