package io.agora.scene.voice.spatial.imkit.manager
...
class ChatroomProtocolDelegate constructor(
    ...
    fun startMicSeatApply(micIndex: Int? = null, callback: CallBack) {
        ...
        attributeMap["chatroomId"] = io.agora.scene.voice.spatial.imkit.manager.ChatroomIMManager.getInstance().currentRoomId
        sendChatroomEvent(true, ownerBean.chatUid, io.agora.scene.voice.spatial.imkit.custorm.CustomMsgType.CHATROOM_APPLY_SITE, attributeMap, callback)
    }
    ...
    fun cancelSubmitMic(chatUid: String, callback: CallBack) {
        ...
        sendChatroomEvent(true, ownerBean.chatUid, io.agora.scene.voice.spatial.imkit.custorm.CustomMsgType.CHATROOM_CANCEL_APPLY_SITE, attributeMap, callback)
    }
    ...
    fun invitationMic(chatUid: String, micIndex: Int? = null, callback: CallBack) {
        ...
        attributeMap["user"] = GsonTools.beanToString(userBeam).toString()
        attributeMap["chatroomId"] = io.agora.scene.voice.spatial.imkit.manager.ChatroomIMManager.getInstance().currentRoomId
        sendChatroomEvent(true, chatUid, io.agora.scene.voice.spatial.imkit.custorm.CustomMsgType.CHATROOM_INVITE_SITE, attributeMap, callback)
    }
    ...
    fun refuseInviteToMic(chatUid: String, callback: CallBack) {
        val attributeMap = mutableMapOf<String, String>()
        attributeMap["chatroomId"] = io.agora.scene.voice.spatial.imkit.manager.ChatroomIMManager.getInstance().currentRoomId
        sendChatroomEvent(true, ownerBean.chatUid, io.agora.scene.voice.spatial.imkit.custorm.CustomMsgType.CHATROOM_INVITE_REFUSED_SITE, attributeMap, callback)
    }
    ...
    private fun sendChatroomEvent(
        isSingle: Boolean, chatUid: String?, eventType: io.agora.scene.voice.spatial.imkit.custorm.CustomMsgType,
        params: MutableMap<String, String>, callback: CallBack
    ) {
        if (isSingle) {
            io.agora.scene.voice.spatial.imkit.custorm.CustomMsgHelper.getInstance().sendCustomSingleMsg(chatUid,
                eventType.getName(), params, object : io.agora.scene.voice.spatial.imkit.custorm.OnMsgCallBack() {
            ...
            io.agora.scene.voice.spatial.imkit.custorm.CustomMsgHelper.getInstance().sendCustomMsg(roomId, params, object : io.agora.scene.voice.spatial.imkit.custorm.OnMsgCallBack() {
                override fun onSuccess(message: io.agora.scene.voice.spatial.imkit.bean.ChatMessageData?) {
                    callback.onSuccess()
