...
public final class VoiceSpatialFragmentContributionRankingBinding implements ViewBinding {
  @NonNull
  ...
  private VoiceSpatialFragmentContributionRankingBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static VoiceSpatialFragmentContributionRankingBinding inflate(
  ...
  public static VoiceSpatialFragmentContributionRankingBinding inflate(
    ...
    View root = inflater.inflate(R.layout.voice_spatial_fragment_contribution_ranking, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static VoiceSpatialFragmentContributionRankingBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new VoiceSpatialFragmentContributionRankingBinding((ConstraintLayout) rootView,
