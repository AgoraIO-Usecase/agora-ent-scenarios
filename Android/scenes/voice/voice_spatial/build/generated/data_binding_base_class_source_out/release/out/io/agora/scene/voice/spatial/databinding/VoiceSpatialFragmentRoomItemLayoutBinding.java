...
public final class VoiceSpatialFragmentRoomItemLayoutBinding implements ViewBinding {
  @NonNull
  ...
  private VoiceSpatialFragmentRoomItemLayoutBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static VoiceSpatialFragmentRoomItemLayoutBinding inflate(
      @NonNull LayoutInflater inflater) {
    return inflate(inflater, null, false);
  }

  @NonNull
  public static VoiceSpatialFragmentRoomItemLayoutBinding inflate(@NonNull LayoutInflater inflater,
      @Nullable ViewGroup parent, boolean attachToParent) {
    View root = inflater.inflate(R.layout.voice_spatial_fragment_room_item_layout, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static VoiceSpatialFragmentRoomItemLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new VoiceSpatialFragmentRoomItemLayoutBinding((ConstraintLayout) rootView, enter, gl45,
