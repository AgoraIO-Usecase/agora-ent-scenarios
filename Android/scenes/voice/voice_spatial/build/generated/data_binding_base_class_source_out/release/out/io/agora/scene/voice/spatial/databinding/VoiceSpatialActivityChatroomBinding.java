...
public final class VoiceSpatialActivityChatroomBinding implements ViewBinding {
  ...
  private VoiceSpatialActivityChatroomBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull ConstraintLayout clMain, @NonNull Guideline glHorizontal45,
      @NonNull Guideline glHorizontal72, @NonNull LikeLayout likeView,
      @NonNull Room3DMicLayout rvChatroom3dMicLayout, @NonNull SVGAImageView svgaView) {
  ...
  public static VoiceSpatialActivityChatroomBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new VoiceSpatialActivityChatroomBinding((ConstraintLayout) rootView, cTopView,
          chatBottom, clMain, glHorizontal45, glHorizontal72, likeView, rvChatroom3dMicLayout,
          svgaView);
    }
