...
public final class VoiceRoomLivingRepository extends io.agora.scene.voice.spatial.viewmodel.repositories.BaseRepository {
    ...
    @org.jetbrains.annotations.NotNull()
    public final androidx.lifecycle.LiveData<io.agora.voice.common.net.Resource<kotlin.Pair<java.lang.Integer, java.lang.Boolean>>> updateBlueRoBotAttenuation(int attenuation) {
        return null;
    }
    
    @org.jetbrains.annotations.NotNull()
    public final androidx.lifecycle.LiveData<io.agora.voice.common.net.Resource<kotlin.Pair<java.lang.Integer, java.lang.Boolean>>> updateRedRoBotAttenuation(int attenuation) {
        return null;
    }
     ...
     */
    @org.jetbrains.annotations.NotNull()
    public final androidx.lifecycle.LiveData<io.agora.voice.common.net.Resource<io.agora.scene.voice.spatial.model.VoiceMicInfoModel>> muteLocal(int micIndex) {
        return null;
    }
     ...
     */
    @org.jetbrains.annotations.NotNull()
    public final androidx.lifecycle.LiveData<io.agora.voice.common.net.Resource<io.agora.scene.voice.spatial.model.VoiceMicInfoModel>> unMuteLocal(int micIndex) {
        return null;
    }
