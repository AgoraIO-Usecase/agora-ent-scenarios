...
public final class VoiceSyncManagerServiceImp implements io.agora.scene.voice.spatial.service.VoiceServiceProtocol {
     ...
     */
    @java.lang.Override()
    public void muteLocal(boolean mute, @org.jetbrains.annotations.NotNull()
    ...
    private final void innerUpdateUserInfo(io.agora.scene.voice.spatial.model.VoiceMemberModel user, kotlin.jvm.functions.Function0<kotlin.Unit> success, kotlin.jvm.functions.Function1<? super java.lang.Exception, kotlin.Unit> error) {
    }
    ...
    private final void seatDownMember(io.agora.scene.voice.spatial.model.VoiceMicInfoModel seat, io.agora.scene.voice.spatial.model.VoiceMemberModel member) {
    }
