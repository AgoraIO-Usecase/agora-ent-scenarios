...
public final class RobotSpatialAudioModel implements io.agora.scene.voice.spatial.model.BaseRoomBean {
    ...
    private double redRobotAttenuation;
    ...
    private double blueRobotAttenuation;
    ...
    public final io.agora.scene.voice.spatial.model.RobotSpatialAudioModel copy(boolean useRobot, int robotVolume, double redRobotAttenuation, boolean redRobotAbsorb, boolean redRobotBlur, double blueRobotAttenuation, boolean blueRobotAbsorb, boolean blueRobotBlur) {
        return null;
    }
    ...
    public RobotSpatialAudioModel(boolean useRobot, int robotVolume, double redRobotAttenuation, boolean redRobotAbsorb, boolean redRobotBlur, double blueRobotAttenuation, boolean blueRobotAbsorb, boolean blueRobotBlur) {
        super();
    }
    ...
    public final double getRedRobotAttenuation() {
        return 0.0;
    }
    
    public final void setRedRobotAttenuation(double p0) {
    }
    ...
    public final double getBlueRobotAttenuation() {
        return 0.0;
    }
    
    public final void setBlueRobotAttenuation(double p0) {
    }
