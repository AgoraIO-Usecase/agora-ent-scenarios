...
public final class RoomAudioSettingsBean implements io.agora.scene.voice.spatial.model.BaseRoomBean {
    ...
    public final io.agora.scene.voice.spatial.model.RoomAudioSettingsBean copy(boolean enable, int roomType, boolean botOpen, int botVolume, int soundSelection, int AINSMode, boolean spatialOpen, boolean isAIAECOn, boolean isAIAGCOn, int voiceChangerMode) {
        return null;
    }
