...
public final class VoiceItemRoomAudienceListBinding implements ViewBinding {
  @NonNull
  ...
  private VoiceItemRoomAudienceListBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static VoiceItemRoomAudienceListBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static VoiceItemRoomAudienceListBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.voice_item_room_audience_list, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static VoiceItemRoomAudienceListBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new VoiceItemRoomAudienceListBinding((ConstraintLayout) rootView, ivAudienceAvatar,
