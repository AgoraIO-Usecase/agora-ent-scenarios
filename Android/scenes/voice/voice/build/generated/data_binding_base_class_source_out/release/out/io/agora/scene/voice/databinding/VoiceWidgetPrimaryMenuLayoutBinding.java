...
public final class VoiceWidgetPrimaryMenuLayoutBinding implements ViewBinding {
  @NonNull
  ...
  private VoiceWidgetPrimaryMenuLayoutBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static VoiceWidgetPrimaryMenuLayoutBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static VoiceWidgetPrimaryMenuLayoutBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.voice_widget_primary_menu_layout, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static VoiceWidgetPrimaryMenuLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new VoiceWidgetPrimaryMenuLayoutBinding((ConstraintLayout) rootView, expressionView,
          iconEmoji, inputBg, inputEditView, inputLayout, inputSend, inputView, menuLayout,
          normalLayout, vKeyboardBg);
    }
