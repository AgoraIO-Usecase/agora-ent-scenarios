...
public final class VoiceItemRoomSoundSelectionBinding implements ViewBinding {
  @NonNull
  ...
  private VoiceItemRoomSoundSelectionBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static VoiceItemRoomSoundSelectionBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static VoiceItemRoomSoundSelectionBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.voice_item_room_sound_selection, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static VoiceItemRoomSoundSelectionBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new VoiceItemRoomSoundSelectionBinding((ConstraintLayout) rootView, ivSoundSelected,
          ivSoundSelectionToggle, llSoundCustomerUsage, llSoundSelectionTips,
