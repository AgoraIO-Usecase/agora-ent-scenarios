...
public final class VoiceDialogBottomSheetContentBinding implements ViewBinding {
  @NonNull
  ...
  private VoiceDialogBottomSheetContentBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static VoiceDialogBottomSheetContentBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static VoiceDialogBottomSheetContentBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.voice_dialog_bottom_sheet_content, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static VoiceDialogBottomSheetContentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new VoiceDialogBottomSheetContentBinding((ConstraintLayout) rootView, ivTitle,
          mtContent, mtTitle);
    }
