...
import io.agora.scene.voice.bean.AINSModeBean
import io.agora.scene.voice.bean.AINSSoundsBean
...
class RoomAINSSheetDialog constructor() : BaseFixedHeightSheetDialog<VoiceDialogChatroomAinsBinding>() {
    ...
    var anisModeCallback: ((ainsModeBean: io.agora.scene.voice.bean.AINSModeBean) -> Unit)? = null

    var anisSoundCallback: ((position: Int, anisSoundBean: io.agora.scene.voice.bean.AINSSoundsBean) -> Unit)? = null
    ...
    private fun initAdapter(recyclerView: RecyclerView) {
        ...
        anisModeAdapter = BaseRecyclerViewAdapter(anisModeList, null, object : OnItemChildClickListener<io.agora.scene.voice.bean.AINSModeBean> {

            override fun onItemChildClick(
                data: io.agora.scene.voice.bean.AINSModeBean?, extData: Any?, view: View, position: Int, itemViewType: Long
            ) {
                data?.let { anisMode ->
                    if (extData is Int) {
        ...
        anisSoundsAdapter = BaseRecyclerViewAdapter(
            anisSoundsList, null, object : OnItemChildClickListener<io.agora.scene.voice.bean.AINSSoundsBean> {

                override fun onItemChildClick(
                    data: io.agora.scene.voice.bean.AINSSoundsBean?, extData: Any?, view: View, position: Int, itemViewType: Long
                ) {
                    data?.let { anisSound ->
                        if (isEnable) {
                            if (extData is Int) {
