package io.agora.scene.voice.ui.audiosettings
...
import io.agora.voice.buddy.tool.doOnProgressChanged
import io.agora.voice.buddy.config.ConfigConstants
import io.agora.voice.buddy.config.ConfigConstants.DISABLE_ALPHA
import io.agora.voice.buddy.config.ConfigConstants.ENABLE_ALPHA
...
class RoomAudioSettingsSheetDialog constructor() : BaseSheetDialog<VoiceDialogAudioSettingBinding>() {
    ...
    private val audioSettingsInfo: io.agora.scene.voice.bean.RoomAudioSettingsBean by lazy {
        arguments?.getSerializable(KEY_AUDIO_SETTINGS_INFO) as io.agora.scene.voice.bean.RoomAudioSettingsBean
    }
