package io.agora.scene.voice.ui.mic.spatial
...
class Room3DMicLayout : ConstraintLayout, View.OnClickListener, IRoomMicView {
    ...
    private lateinit var binding: VoiceViewRoom3dMicLayoutBinding
    ...
    private fun init(context: Context) {
        val root = View.inflate(context, R.layout.voice_view_room_3d_mic_layout, this)
        binding = VoiceViewRoom3dMicLayoutBinding.bind(root)
