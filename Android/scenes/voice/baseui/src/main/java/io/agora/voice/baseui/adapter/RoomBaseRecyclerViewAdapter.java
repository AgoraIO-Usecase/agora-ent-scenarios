...
import io.agora.voice.baseui.R;
 ...
 * @param <T>
 */
public abstract class RoomBaseRecyclerViewAdapter<T> extends RoomBaseAdapter<RoomBaseRecyclerViewAdapter.ViewHolder<T>> {
    ...
    public abstract static class ViewHolder<T> extends RecyclerView.ViewHolder {
        private RoomBaseAdapter<ViewHolder<T>> adapter;
         ...
         * @return
         */
        public RoomBaseAdapter<ViewHolder<T>> getAdapter() {
            return adapter;
        }
    }
