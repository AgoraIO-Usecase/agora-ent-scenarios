...
class SubApiManager {
    ...
    /** 忽然游戏列表  */
    fun getSubGameList(): List<SubGameListModel> {
        // 休闲娱乐
        val leisureAndEntertainment = SubGameListModel(
            gameType = SubGameType.leisure_and_entertainment,
        ...
        // 语音互动
        val voiceInteractions = SubGameListModel(
            gameType = SubGameType.voice_interaction,
            gameList = mutableListOf(
        ...
        // 实时竞技
        val realtimeCompetitions = SubGameListModel(
            gameType = SubGameType.realtime_competition,
            gameList = mutableListOf(
        ...
        // 经典棋牌
        val classicBoardGameList = SubGameListModel(
            gameType = SubGameType.classic_board_games,
            gameList = mutableListOf(
        ...
        // Party Game
        val partyGameList = SubGameListModel(
            gameType = SubGameType.party_games,
            gameList = mutableListOf(
    ...
    private fun buildGameModel(
        gameId: Long,
        gameName: String,
        gamePic: Int,
    ): SubGameInfoModel {
        val model: SubGameInfoModel = SubGameInfoModel().apply {
            this.gameId = gameId
     ...
     * @return
     */
    fun getYYGameList(): List<SubGameListModel> {
        // 休闲娱乐
        val leisureAndEntertainment = SubGameListModel(
            gameType = SubGameType.leisure_and_entertainment,
            gameList = mutableListOf(
     ...
     * @return
     */
    fun getGroupPlayList(): List<SubGameListModel> {
        // 休闲娱乐
        val leisureAndEntertainment = SubGameListModel(
            gameType = SubGameType.leisure_and_entertainment,
            gameList = mutableListOf(
                buildWebGameModel("https://demo.grouplay.cn/room?name=&gameType=17&roomType=17", "飞行棋", R.drawable.play_zone_qw_fxq),
                buildWebGameModel("https://demo.grouplay.cn/room?name=&gameType=27&roomType=27", "蛇梯", R.drawable.play_zone_qw_st),
                buildWebGameModel("https://demo.grouplay.cn/room?name=&gameType=3&roomType=3", "猜成语", R.drawable.play_zone_qw_cyjl),
                buildWebGameModel("https://demo.grouplay.cn/room?name=&gameType=2&roomType=2", "猜图片", R.drawable.play_zone_qw_ctp),
            )
        )
