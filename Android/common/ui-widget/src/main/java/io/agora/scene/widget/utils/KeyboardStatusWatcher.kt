...
import io.agora.scene.base.utils.hasNavBar
import io.agora.scene.base.utils.isFullScreen
import io.agora.scene.base.utils.isPortrait
import io.agora.scene.base.utils.navBarHeight
import io.agora.scene.base.utils.screenHeight
import io.agora.scene.base.utils.statusBarHeight
import io.agora.scene.widget.CommonUILogger
...
class KeyboardStatusWatcher(
    ...
    override fun onGlobalLayout() {
        ...
        if (heightDiff > activity.screenHeight / 3) {
            ...
            if (activity.hasNavBar && activity.hasNavBar && activity.isPortrait) {
                keyboardHeight -= activity.navBarHeight
                CommonUILogger.d(TAG, "keyboardHeight = $keyboardHeight   ")
            }
        } else {
            //软键盘隐藏时键盘高度为0
