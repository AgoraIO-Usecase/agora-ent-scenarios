    ...
    private fun setPrivacyText() {
        ...
        val clickableSpan = object : ClickableSpan() {
            override fun onClick(widget: View) {
                PagePilotManager.pageWebView("www.baidu.com")
            }

            override fun updateDrawState(ds: TextPaint) {
                super.updateDrawState(ds)
                ds.color = ContextCompat.getColor(requireContext(), io.agora.scene.widget.R.color.blue_2e)
                ds.isUnderlineText = false
            }
        }

        spannableString.setSpan(clickableSpan, 6, 13, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE)
        ...
        spannableString.setSpan(privacySpan, 14, 21, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE)
        ...
        spannableString.setSpan(userSpan, 23, 28, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE)
