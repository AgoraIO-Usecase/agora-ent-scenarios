...
class AUIBroadcastMessageView : AppCompatTextView, IAUIChatListView {
    ...
    private fun initAttrs(context: Context, attrs: AttributeSet?) {
        val typeArray = context.obtainStyledAttributes(attrs, R.styleable.aui_SubtitleView)
        mMarqueeMode = typeArray.getInt(R.styleable.aui_SubtitleView_voice_customScrollSpeed,mMarqueeMode)
        typeArray.recycle()
    }
