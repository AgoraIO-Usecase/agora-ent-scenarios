...
/usr/libexec/PlistBuddy -c "Set :objects:DD2A43F228FFCEE7004CEDCF:buildSettings:CURRENT_PROJECT_VERSION ${CURRENT_PROJECT_VERSION}" $PBXPROJ_PATH
# Release
...
/usr/libexec/PlistBuddy -c "Set :objects:DD2A43F328FFCEE7004CEDCF:buildSettings:CURRENT_PROJECT_VERSION ${CURRENT_PROJECT_VERSION}" $PBXPROJ_PATH
