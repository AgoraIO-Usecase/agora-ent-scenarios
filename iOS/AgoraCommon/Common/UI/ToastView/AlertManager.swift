...
//            vc = BaseViewController()
    ...
    static public func hiddenView(all: Bool = true, completion: (() -> Void)? = nil) {
        if vc == nil {
            completion?()
            return
        }
...
extension UIViewController {
    ...
    static public func cl_topViewController(_ viewController: UIViewController? = nil) -> UIViewController? {
