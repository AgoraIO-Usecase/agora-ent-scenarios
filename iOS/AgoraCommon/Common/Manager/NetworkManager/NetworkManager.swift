...
//            ToastView.hidden()
    ...
    public func generateIMConfig(type: Int,
        ...
        let params = ["appId": AppContext.shared.appId,
                      "chat": chatParams,
                      "src": "iOS",
                      "im": imConfig,
                      "payload": payload,
...
//            ToastView.hidden()
    ...
    public func startCloudPlayer(channelName: String,
                          ...
                          streamUrl: String,
                          success: @escaping (String?) -> Void) {
        let params: [String: Any] = ["appId": AppContext.shared.appId,
                                     "appCert": AppContext.shared.certificate,
                                     "basicAuth":basicAuth(key: AppContext.shared.cloudPlayerKey, password: AppContext.shared.cloudPlayerSecret),
                                        "channelName": channelName,
                                        "uid": uid,
                                        "robotUid": robotUid,
                                        "region": "cn",
    ...
    public func cloudPlayerHeartbeat(channelName: String,
                              uid: String,
                              success: @escaping (String?) -> Void) {
        let params: [String: String] = ["appId": AppContext.shared.appId,
                                        "channelName": channelName,
                                        "uid": uid,
                                        "src": "iOS",
                                        "traceId": NSString.withUUID().md5() ?? ""]
