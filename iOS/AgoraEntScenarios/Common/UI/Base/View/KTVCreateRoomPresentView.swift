...
@objc public class KTVCreateRoomPresentView: UIView, UIGestureRecognizerDelegate {
    
    fileprivate let screenSize: CGSize = UIScreen.main.bounds.size
    
    @objc public static var shared: KTVCreateRoomPresentView = KTVCreateRoomPresentView()
    ...
    @objc public func showView(with frame: CGRect, vc: UIViewController) {
    ...
    @objc public func push(with vc: UIViewController, frame: CGRect, maxHeight: CGFloat) {
        frames.append(frame)
...
extension UIView {
    public func setTopCornerRadius(radius: CGFloat) {
