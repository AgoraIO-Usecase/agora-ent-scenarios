...
@objcMembers final class AboutAgoraEntertainmentViewController: VRBaseViewController {
    ...
    var infos = [["contents":[["title":NSLocalizedString("ContactCustomerService", comment: ""),"detail":"400-632-6626"],["title":NSLocalizedString("OfficialWebsiteAddress", comment: ""),"detail":"https://www.shengwang.cn"]],"sectionName":""],["contents":[["title":"语聊房","detail":"2.0.1-YL-1.2"],["title":"语聊房-空间音频模式","detail":"2.0.1-YLKJ-1.2"],["title":"在线K歌房","detail":"2.0.0-KTV-2.1.1"],["title":"秀场直播","detail":"3.0.0-ZB-1.0"]],"sectionName":NSLocalizedString("SceneVersion", comment: "")]]
