...
struct VLDiscoveryModel {
    ...
    static func createData() -> [VLDiscoveryModel] {
        ...
        sesstionModel.items = [VLDiscoveryItemModel(title: NSLocalizedString("ktv_online", comment: ""),
                                                    ...
                                                    documentUrl: "https://doc.shengwang.cn/doc/online-ktv/ios/ktv-scenario/landing-page",                                                    schemeUrl: "https://www.shengwang.cn/solution/online-karaoke/",
                                                    type: .ktv,
                                                    layoutType: .side),
                               VLDiscoveryItemModel(title: NSLocalizedString("discover_voice_chat_scene_title", comment: ""),
                                                    ...
                                                    documentUrl: "https://doc.shengwang.cn/doc/chatroom/ios/sdk/landing-page",                                                    schemeUrl: "https://www.shengwang.cn/solution/voicechat/",
                                                    type: .voice,
                                                    layoutType: .full),
