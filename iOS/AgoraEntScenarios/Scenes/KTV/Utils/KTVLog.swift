...
@objc class KTVLog: NSObject {
    fileprivate static let provider = KTVLogProvider(domainName: "KTV")

    @objc static func errorText(text: String,
                                tag: String? = nil)
    {
...
class KTVLogProvider {
    ...
    fileprivate func log(type: KTVAgoraLogType,
                         text: String,
                         tag: String?)
    {
...
extension KTVLogProvider {
    enum KTVAgoraLogType {
...
class KTVLogUtil {
    ...
    func log(message: String) {
        let item = KTVLogItem(message: message, dateTime: Date())
        logs.append(item)
        #if DEBUG
...
extension KTVLogUtil {
    struct KTVLogItem: CustomStringConvertible {
        var message: String
        var dateTime: Date
