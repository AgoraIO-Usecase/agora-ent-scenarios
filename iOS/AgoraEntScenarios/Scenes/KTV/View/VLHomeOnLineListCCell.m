...
- (void)setupView {
    ...
    self.lockImgView.image = [UIImage sceneImageWithName:@"suo" bundleName:@"KtvResource"];
    ...
    self.onListIconView.image = [UIImage sceneImageWithName:@"online_list_countIcon"  bundleName:@"KtvResource"];
