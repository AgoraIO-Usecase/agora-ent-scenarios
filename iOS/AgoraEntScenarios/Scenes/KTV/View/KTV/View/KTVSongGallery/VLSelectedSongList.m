...
- (void)setupView{
    ...
    searchIcon.image = [UIImage sceneImageWithName:@"ktv_search_icon" bundleName:@"KtvResource"];
    ...
    [clearButton setImage:[UIImage sceneImageWithName:@"ktv_search_clearIcon" bundleName:@"KtvResource"]
