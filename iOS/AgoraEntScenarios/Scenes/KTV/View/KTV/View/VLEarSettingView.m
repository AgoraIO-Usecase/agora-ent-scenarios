...
- (void)initSubViews {
    ...
    [_earWarningBtn setImage:[UIImage sceneImageWithName:@"ktv_add_circle" bundleName:@"KtvResource"] forState:UIControlStateNormal];
    [_earWarningBtn setImage:[UIImage sceneImageWithName:@"ktv_add_circle_in" bundleName:@"KtvResource"] forState:UIControlStateSelected];
    ...
    textAttachment.image = [UIImage sceneImageWithName:@"ktv_add_circle_in" bundleName:@"KtvResource"];
