...
- (void)setupView {
    ...
    self.bgImgView.image = [UIImage sceneImageWithName:@"bg-lyric" bundleName:@"KtvResource"];
...
//    self.bgImgView.layer.masksToBounds = YES;
    ...
    currentPlayImgView.image = [UIImage sceneImageWithName:@"ktv_currentPlay_icon" bundleName:@"KtvResource"];
   ...
   // _karaokeView.scoringView.showDebugView = true;
    ...
    [self.joinChorusBtn setBackgroundImage:[UIImage sceneImageWithName:@"ic_join_chorus" bundleName:@"KtvResource"] forState:UIControlStateNormal];
    [self.joinChorusBtn setBackgroundImage:[UIImage sceneImageWithName:@"ic_join_chorus_loading" bundleName:@"KtvResource"] forState:UIControlStateSelected];
    ...
    [self.leaveChorusBtn setImage:[UIImage sceneImageWithName:@"Union" bundleName:@"KtvResource"] forState:UIControlStateNormal];
    ...
    _iconView.image = [UIImage sceneImageWithName:@"ktv_showVoice" bundleName:@"KtvResource"];
...
- (void)changeBgViewByModel:(VLKTVSelBgModel *)selBgModel {
    self.bgImgView.image = [UIImage sceneImageWithName:selBgModel.imageName bundleName:@"KtvResource"];
}
...
- (void)setOriginBtnState:(VLKTVMVViewActionType)type
{
    switch (type) {
        case VLKTVMVViewActionTypeSingOrigin:
            ...
            [self.trackBtn setImage:[UIImage sceneImageWithName:@"original" bundleName:@"KtvResource"] forState:UIControlStateSelected];
            break;
        case VLKTVMVViewActionTypeSingLead:
            ...
            [self.trackBtn setImage:[UIImage sceneImageWithName:@"original" bundleName:@"KtvResource"] forState:UIControlStateNormal];
            break;
        case VLKTVMVViewActionTypeSingAcc:
            _trackBtn.selected = NO;
            [_trackBtn setTitle:KTVLocalizedString(@"ktv_ori_sing") forState:UIControlStateNormal];
            [self.trackBtn setImage:[UIImage sceneImageWithName:@"acc" bundleName:@"KtvResource"] forState:UIControlStateNormal];
            break;
        default:
            break;
    }
...
- (VLHotSpotBtn *)pauseBtn {
    if (!_pauseBtn) {
        ...
        [_pauseBtn setImage:[UIImage sceneImageWithName:@"ktv_pause_icon" bundleName:@"KtvResource"] forState:UIControlStateSelected];
        [_pauseBtn setImage:[UIImage sceneImageWithName:@"ktv_pause_resumeicon" bundleName:@"KtvResource"] forState:UIControlStateNormal];
...
- (VLHotSpotBtn *)nextButton {
    if (!_nextButton) {
        ...
        [_nextButton setImage:[UIImage sceneImageWithName:@"ktv_playNext_icon" bundleName:@"KtvResource"] forState:UIControlStateNormal];
...
- (VLHotSpotBtn *)trackBtn {
    if (!_trackBtn) {
        ...
        [_trackBtn setImage:[UIImage sceneImageWithName:@"ktv_mic_acc" bundleName:@"KtvResource"] forState:UIControlStateSelected];
        [_trackBtn setImage:[UIImage sceneImageWithName:@"ktv_mic_origin" bundleName:@"KtvResource"] forState:UIControlStateNormal];
        _trackBtn.selected = NO;
...
- (VLHotSpotBtn *)settingBtn {
    if (!_settingBtn) {
        ...
        [_settingBtn setImage:[UIImage sceneImageWithName:@"ktv_subtitle_icon" bundleName:@"KtvResource"] forState:UIControlStateNormal];
