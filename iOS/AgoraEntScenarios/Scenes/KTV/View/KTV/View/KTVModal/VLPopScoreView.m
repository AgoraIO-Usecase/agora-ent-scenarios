...
- (void)configScore:(int)score {
    ...
    _scoreImgView.image = [UIImage sceneImageWithName:imageNamed bundleName:@"KtvResource"];
}
...
- (UIImageView *)starImageView {
    if (!_starImageView) {
        ...
        _starImageView.image = [UIImage sceneImageWithName:@"ktv_score_star" bundleName:@"KtvResource"];
    }
...
- (UIImageView *)scoreImgView {
    if (!_scoreImgView) {
        ...
        _scoreImgView.image = [UIImage sceneImageWithName:@"ktv_score_S" bundleName:@"KtvResource"];
    }
...
- (UIImageView *)circleLightImageView {
    if (!_circleLightImageView) {
        ...
        _circleLightImageView.image = [UIImage sceneImageWithName:@"ktv_score_topPart" bundleName:@"KtvResource"];
    }
...
- (UIImageView *)circleImageView {
    if (!_circleImageView) {
        ...
        _circleImageView.image = [UIImage sceneImageWithName:@"ktv_score_bottomPart" bundleName:@"KtvResource"];
    }
