...
- (void)setupView {
    ...
    [backBtn setImage:[UIImage sceneImageWithName:@"ktv_back_whiteIcon" bundleName:@"KtvResource"] forState:UIControlStateNormal];
    ...
    [audioBtn setImage:[UIImage sceneImageWithName:@"KTV_onLineType_audionIcon" bundleName:@"KtvResource"] forState:UIControlStateNormal];
...
//    audioBtn.imagePosition = QMUIButtonImagePositionLeft;
    ...
    self.audioSelImgView.image = [UIImage sceneImageWithName:@"ktv_selbg_icon" bundleName:@"KtvResource"];
    self.audioSelImgView.hidden = YES;
    ...
    [audioBtn setImage:[UIImage sceneImageWithName:@"KTV_onLineType_videoIcon" bundleName:@"KtvResource"] forState:UIControlStateNormal];
...
//    self.videoBtn.adjustsButtonWhenHighlighted = NO;
    ...
    self.videoSelImgView.image = [UIImage sceneImageWithName:@"ktv_selbg_icon" bundleName:@"KtvResource"];
