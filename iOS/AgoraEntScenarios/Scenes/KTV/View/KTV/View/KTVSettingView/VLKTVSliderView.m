...
- (UISlider *)sliderView {
    if (!_sliderView) {
        ...
        [_sliderView setThumbImage:[UIImage sceneImageWithName:@"icon_ktv_slider" bundleName:@"KtvResource"] forState:UIControlStateNormal];
        [_sliderView setThumbImage:[UIImage sceneImageWithName:@"icon_ktv_slider" bundleName:@"KtvResource"] forState:UIControlStateHighlighted];
...
- (UIButton *)addButton {
    if (!_addButton) {
        ...
        [_addButton setImage:[UIImage sceneImageWithName:@"icon_ktv_add" bundleName:@"KtvResource"] forState:UIControlStateNormal];
...
- (UIButton *)reduceButton {
    if (!_reduceButton) {
        ...
        [_reduceButton setImage:[UIImage sceneImageWithName:@"icon_ktv_reduce" bundleName:@"KtvResource"] forState:UIControlStateNormal];
