...
//                                                   ballSize:22];
    ...
    circleImgView.image = [UIImage sceneImageWithName:@"ktv_circle_bgIcon" bundleName:@"KtvResource"];
    ...
    self.rotateImgView.image = [UIImage sceneImageWithName:@"ktv_soundEffert_icon" bundleName:@"KtvResource"];
