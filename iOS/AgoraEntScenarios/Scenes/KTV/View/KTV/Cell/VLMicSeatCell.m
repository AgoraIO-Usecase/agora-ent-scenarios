...
- (void)setupView {
    ...
    self.roomerImgView.image = [UIImage sceneImageWithName:@"ktv_roomOwner_icon" bundleName:@"KtvResource"];
    ...
    self.muteImgView.image = [UIImage sceneImageWithName:@"ktv_self_seatMute" bundleName:@"KtvResource"];
    ...
    [self.singingBtn setImage:[UIImage sceneImageWithName:@"ktv_seatsinging_icon" bundleName:@"KtvResource"] forState:UIControlStateNormal];
...
//    self.singingBtn.imagePosition = QMUIButtonImagePositionLeft;
    ...
    [self.joinChorusBtn setImage:[UIImage sceneImageWithName:@"ic_hc" bundleName:@"KtvResource"] forState:UIControlStateNormal];
