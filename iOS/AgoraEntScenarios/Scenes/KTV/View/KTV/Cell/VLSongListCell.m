...
- (void)setUpView {
    ...
    self.picImgView.image = [UIImage sceneImageWithName:@"online_temp_icon" bundleName:@"KtvResource"];
...
//    [self addSubview:self.typeLabel];
    ...
    [self.deleteBtn setImage:[UIImage sceneImageWithName:@"ktv_delete_icon" bundleName:@"KtvResource"] forState:UIControlStateNormal];
    ...
    [self.sortBtn setImage:[UIImage sceneImageWithName:@"ktv_sort_icon" bundleName:@"KtvResource"] forState:UIControlStateNormal];
    ...
    [self.singingBtn setImage:[UIImage sceneImageWithName:@"ktv_singing_icon" bundleName:@"KtvResource"] forState:UIControlStateNormal];
...
- (void)setSelSongModel:(VLRoomSelSongModel *)selSongModel {
    ...
    [self.picImgView sd_setImageWithURL:[NSURL URLWithString:selSongModel.imageUrl]
                       placeholderImage:[UIImage sceneImageWithName:@"default_avatar" bundleName:@"KtvResource"]];
}
