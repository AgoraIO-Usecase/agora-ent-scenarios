...
- (void)setupView {
    ...
    warImgView.image = [UIImage sceneImageWithName:@"zhuyi" bundleName:@"KtvResource"];
    ...
    [randomBtn setImage:[UIImage sceneImageWithName:@"online_create_randomIcon" bundleName:@"KtvResource"] forState:UIControlStateNormal];
    ...
    [self.enBtn setBackgroundImage:[UIImage sceneImageWithName:@"guan" bundleName:@"KtvResource"] forState:UIControlStateNormal];
    [self.enBtn setBackgroundImage:[UIImage sceneImageWithName:@"open" bundleName:@"KtvResource"] forState:UIControlStateSelected];
    ...
    [createBtn setBackgroundImage:[UIImage sceneImageWithName:@"createRoomBtn" bundleName:@"KtvResource"] forState:UIControlStateNormal];
...
- (void)randomBtnClickEvent {
    ...
    self.iconImgView.image = [UIImage sceneImageWithName: iconName  bundleName:@"KtvResource"];
}
