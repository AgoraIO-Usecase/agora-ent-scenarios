...
@implementation VLSBGHomeOnLineListCCell
...
- (void)setupView {
    ...
    self.lockImgView.image = [UIImage sceneImageWithName:@"suo" bundleName:@"sbgResource"];
    ...
    self.onListIconView.image = [UIImage sceneImageWithName:@"online_list_countIcon" bundleName:@"sbgResource"];
