...
- (void)setupView {
    ...
    [backBtn setImage:[UIImage sceneImageWithName:@"ktv_back_whiteIcon" bundleName:@"sbgResource"] forState:UIControlStateNormal];
    ...
    [audioBtn setImage:[UIImage sceneImageWithName:@"KTV_onLineType_audionIcon" bundleName:@"sbgResource"] forState:UIControlStateNormal];
...
//    self.audioBtn.adjustsButtonWhenHighlighted = NO;
    ...
    self.audioSelImgView.image = [UIImage sceneImageWithName:@"ktv_selbg_icon" bundleName:@"sbgResource"];
    self.audioSelImgView.hidden = YES;
    ...
    [audioBtn setImage:[UIImage sceneImageWithName:@"KTV_onLineType_videoIcon" bundleName:@"sbgResource"] forState:UIControlStateNormal];
...
//    self.videoBtn.adjustsButtonWhenHighlighted = NO;
    ...
    self.videoSelImgView.image = [UIImage sceneImageWithName:@"ktv_selbg_icon" bundleName:@"sbgResource"];
