...
@interface VLSBGDropOnLineView ()

@property(nonatomic, weak) id <VLSBGDropOnLineViewDelegate>delegate;
@property (nonatomic, strong) UIImageView *avatarImgView;
@property (nonatomic, strong) UILabel *nickNameLabel;

@end

@implementation VLSBGDropOnLineView
...
- (void)setupView {
    ...
    [dropLineBtn setTitle:SBGLocalizedString(@"sbg_room_seat_off") forState:UIControlStateNormal];
...
- (void)setSeatModel:(VLSBGRoomSeatModel *)seatModel {
