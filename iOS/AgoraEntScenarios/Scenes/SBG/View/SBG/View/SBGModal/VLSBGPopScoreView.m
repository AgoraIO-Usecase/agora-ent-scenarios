...
@property(nonatomic, weak) id <VLSBGPopScoreViewDelegate>delegate;
...
@implementation VLSBGPopScoreView
...
- (void)configScore:(int)score {
    ...
    _scoreImgView.image = [UIImage sceneImageWithName:imageNamed bundleName:@"sbgResource"];
}
...
- (UIImageView *)starImageView {
    if (!_starImageView) {
        ...
        _starImageView.image = [UIImage sceneImageWithName:@"ktv_score_star" bundleName:@"sbgResource"];
    }
...
- (UIImageView *)scoreImgView {
    if (!_scoreImgView) {
        ...
        _scoreImgView.image = [UIImage sceneImageWithName:@"ktv_score_S" bundleName:@"sbgResource"];
    }
...
- (UIImageView *)circleLightImageView {
    if (!_circleLightImageView) {
        ...
        _circleLightImageView.image = [UIImage sceneImageWithName:@"ktv_score_topPart" bundleName:@"sbgResource"];
    }
...
- (UIImageView *)circleImageView {
    if (!_circleImageView) {
        ...
        _circleImageView.image = [UIImage sceneImageWithName:@"ktv_score_bottomPart" bundleName:@"sbgResource"];
    }
...
- (UIButton *)confirmButton {
    if (!_confirmButton) {
        ...
        [_confirmButton setTitle:SBGLocalizedString(@"sbg_ok") forState:UIControlStateNormal];
