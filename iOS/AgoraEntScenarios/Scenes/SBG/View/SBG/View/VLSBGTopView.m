...
- (void)setupView {
    ...
    logoImgView.image = [UIImage sbg_sceneImageWithName:@""];
    ...
    [closeBtn setImage:[UIImage sbg_sceneImageWithName:@"close_room"] forState:UIControlStateNormal];
    [closeBtn addTarget:self action:@selector(closeBtnEvent:) forControlEvents:UIControlEventTouchUpInside];
    [self addSubview:closeBtn];
    
    UIButton *moreButton = [[UIButton alloc] init];
    [moreButton setImage:[UIImage sbg_sceneImageWithName:@"icon_live_more"] forState:(UIControlStateNormal)];
    ...
    [self.networkStatusBtn setImage:[UIImage sbg_sceneImageWithName:@"ktv_network_wellIcon"] forState:UIControlStateNormal];
...
- (void)setNetworkQuality:(int)quality
{
    if(quality == 0) {
        ...
        [self.networkStatusBtn setImage:[UIImage sbg_sceneImageWithName:@"ktv_network_okIcon"] forState:UIControlStateNormal];
        [self.networkStatusBtn setTitle:SBGLocalizedString(@"sbg_net_status_m") forState:UIControlStateNormal];
    }
    else if(quality == 2) {
        [self.networkStatusBtn setImage:[UIImage sbg_sceneImageWithName:@"ktv_network_badIcon"] forState:UIControlStateNormal];
