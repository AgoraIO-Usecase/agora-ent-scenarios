...
- (UIButton *)songNumBtn {
    if (!_songNumBtn) {
     ...
     //   _songNumBtn.contentMode = UIViewContentModeScaleAspectFit;
        [_songNumBtn setBackgroundImage:[UIImage sceneImageWithName:@"sbg-btn-start-disabled" bundleName:@"sbgResource"] forState:UIControlStateSelected];
        [_songNumBtn setBackgroundImage:[UIImage sceneImageWithName:@"sbg-btn-start" bundleName:@"sbgResource"] forState:UIControlStateNormal];
