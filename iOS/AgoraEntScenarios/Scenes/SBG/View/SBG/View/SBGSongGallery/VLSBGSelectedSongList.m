...
- (void)setupView{
    ...
    searchIcon.image = [UIImage sceneImageWithName:@"ktv_search_icon" bundleName:@"sbgResource"];
    ...
    [clearButton setImage:[UIImage sceneImageWithName:@"ktv_search_clearIcon" bundleName:@"sbgResource"]
