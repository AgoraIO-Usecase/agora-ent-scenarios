...
@implementation VLSBGSliderView
...
- (UISlider *)sliderView {
    if (!_sliderView) {
        ...
        [_sliderView setThumbImage:[UIImage sceneImageWithName:@"icon_ktv_slider" bundleName:@"sbgResource"] forState:UIControlStateNormal];
        [_sliderView setThumbImage:[UIImage sceneImageWithName:@"icon_ktv_slider" bundleName:@"sbgResource"] forState:UIControlStateHighlighted];
