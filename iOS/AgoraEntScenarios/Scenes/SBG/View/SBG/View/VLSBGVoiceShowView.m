...
#import "SBGMacro.h"
@interface VLSBGVoiceShowView()
@property(nonatomic, weak) id <VLSBGVoiceShowViewDelegate>delegate;
@property (nonatomic,strong) UIButton *selBtn;
@end

@implementation VLSBGVoiceShowView
...
-(void)layoutUIWithDataSource:(NSArray *)dataSource {
    ...
    titleLabel.text = SBGLocalizedString(@"设置人声突出");
