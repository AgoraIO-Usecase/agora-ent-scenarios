...
@implementation VLSBGSelectedSongListCell
...
- (void)setUpView {
    ...
    [self.chooseBtn setTitle:SBGLocalizedString(@"sbg_order_song") forState:UIControlStateNormal];
...
- (void)setSongItemModel:(VLSBGSongItmModel *)songItemModel {
    ...
    if (songItemModel.ifChoosed) {
        ...
        [self.chooseBtn setTitle:SBGLocalizedString(@"sbg_room_chosen_song_list") forState:UIControlStateNormal];
