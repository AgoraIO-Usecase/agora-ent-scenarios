...
//    self.typeLabel.text = @"合唱";
    ...
    [self.chooseBtn setTitle:SBGLocalizedString(@"点歌") forState:UIControlStateNormal];
...
- (void)setSongItemModel:(VLSBGSongItmModel *)songItemModel {
    ...
    if (songItemModel.ifChoosed) {
        ...
        [self.chooseBtn setTitle:SBGLocalizedString(@"已点") forState:UIControlStateNormal];
