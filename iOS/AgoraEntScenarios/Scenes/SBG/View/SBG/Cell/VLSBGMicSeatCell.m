...
- (void)setupView {
    ...
    self.roomerImgView.image = [UIImage sceneImageWithName:@"ktv_roomOwner_icon" bundleName:@"sbgResource"];
    ...
    self.muteImgView.image = [UIImage sceneImageWithName:@"ktv_self_seatMute" bundleName:@"sbgResource"];
    ...
    [self.singingBtn setImage:[UIImage sceneImageWithName:@"ktv_seatsinging_icon" bundleName:@"sbgResource"] forState:UIControlStateNormal];
