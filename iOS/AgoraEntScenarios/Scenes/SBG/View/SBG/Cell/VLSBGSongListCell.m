...
@implementation VLSBGSongListCell
...
- (void)setUpView {
    ...
    self.picImgView.image = [UIImage sceneImageWithName:@"online_temp_icon" bundleName:@"sbgResource"];
...
//    [self addSubview:self.typeLabel];
    ...
    [self.deleteBtn setImage:[UIImage sceneImageWithName:@"ktv_delete_icon" bundleName:@"sbgResource"] forState:UIControlStateNormal];
    ...
    [self.sortBtn setImage:[UIImage sceneImageWithName:@"ktv_sort_icon" bundleName:@"sbgResource"] forState:UIControlStateNormal];
    ...
    [self.singingBtn setImage:[UIImage sceneImageWithName:@"ktv_singing_icon" bundleName:@"sbgResource"] forState:UIControlStateNormal];
...
//    else if (selSongModel.status == VLSBGSongPlayStatusPlaying){
...
//    }
    ...
    [self.picImgView sd_setImageWithURL:[NSURL URLWithString:selSongModel.imageUrl]
                       placeholderImage:[UIImage sceneImageWithName:@"default_avatar" bundleName:@"sbgResource"]];
}
