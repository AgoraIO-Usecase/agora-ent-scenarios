...
OBJC_EXPORT NSString* _Nullable const sTitleKey;
OBJC_EXPORT const NSString* _Nullable const sSelectedParamKey;
OBJC_EXPORT const NSString* _Nullable const sUnselectedParamKey;
NS_ASSUME_NONNULL_BEGIN

@interface SBGDebugInfo : NSObject
