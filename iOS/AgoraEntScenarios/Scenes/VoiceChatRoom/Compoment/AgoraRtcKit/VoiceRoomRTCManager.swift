    ...
    private var baseMusicCount: Int = 0 {
        didSet {
            ...
            case .alien:
                ...
                musicPath = "\(AgoraConfig.CreateCommonRoom)\(AgoraConfig.baseAlienMic[baseMusicCount])"
            case .ainsHigh:
                count = AgoraConfig.HighAINSIntroduc.count
                musicPath = "\(AgoraConfig.SetAINSIntroduce)\(AgoraConfig.HighAINSIntroduc[baseMusicCount])"
            case .ainsMid:
                count = AgoraConfig.MediumAINSIntroduc.count
                musicPath = "\(AgoraConfig.SetAINSIntroduce)\(AgoraConfig.MediumAINSIntroduc[baseMusicCount])"
            case .ainsOff:
                count = AgoraConfig.NoneAINSIntroduc.count
                musicPath = "\(AgoraConfig.SetAINSIntroduce)\(AgoraConfig.NoneAINSIntroduc[baseMusicCount])"
            case .social:
                count = AgoraConfig.SoundSelectSocial.count
                musicPath = AgoraConfig.SoundSelectSocial[baseMusicCount]
            case .ktv:
                count = AgoraConfig.SoundSelectKTV.count
                musicPath = AgoraConfig.SoundSelectKTV[baseMusicCount]
            case .game:
                count = AgoraConfig.SoundSelectGame.count
                musicPath = AgoraConfig.SoundSelectGame[baseMusicCount]
            case .anchor:
                count = AgoraConfig.SoundSelectAnchor.count
                musicPath = AgoraConfig.SoundSelectAnchor[baseMusicCount]
            case .sound:
                return
            }
