...
public class VRCreateRoomInputView: UIView, UITextFieldDelegate {
    ...
    public let barHeight = ((ScreenWidth - 90 - 3 * 16) / 4.0) * (53 / 60.0)
    ...
    lazy var pinCode: VRVerifyCodeView = .init(frame: CGRect(x: 0, y: self.publicChoice.frame.maxY + 15, width: ScreenWidth, height: self.barHeight), codeNumbers: 4, space: 16, padding: 45)
