...
public class VRSoundEffectsCell: UITableViewCell, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    lazy var chooseSymbol: UIImageView = .init(frame: CGRect(x: self.background.frame.width - 32, y: self.frame.height - 31, width: 32, height: 31)).image(UIImage("check")!).contentMode(.scaleAspectFit)
...
extension VRSoundEffectsCell {
    static func items() -> [VRRoomMenuBarEntity] {
        ...
        do {
            for dic in [["title": LanguageManager.localValue(key: "Social Chat"), "detail": LanguageManager.localValue(key: "This sound effect focuses on solving the voice call problem of the Social Chat scene, including noise cancellation and echo suppression of the anchor's voice. It can enable users of different network environments and models to enjoy ultra-low delay and clear and beautiful voice in multi-person chat."), "selected": true, "index": 0, "soundType": 0], ["title": LanguageManager.localValue(key: "Karaoke"), "detail": LanguageManager.localValue(key: "This sound effect focuses on solving all kinds of problems in the Karaoke scene of single-person or multi-person singing, including the balance processing of accompaniment and voice, the beautification of sound melody and voice line, the volume balance and real-time synchronization of multi-person chorus, etc. It can make the scenes of Karaoke more realistic and the singers' songs more beautiful."), "selected": false, "index": 1, "soundType": 1], ["title": LanguageManager.localValue(key: "Gaming Buddy"), "detail": LanguageManager.localValue(key: "This sound effect focuses on solving all kinds of problems in the game scene where the anchor plays with him, including the collaborative reverberation processing of voice and game sound, the melody of sound and the beautification of sound lines. It can make the voice of the accompanying anchor more attractive and ensure the scene feeling of the game voice. "), "selected": false, "index": 2, "soundType": 2], ["title": LanguageManager.localValue(key: "Professional Podcaster"), "detail": LanguageManager.localValue(key: "This sound effect focuses on solving the problems of poor sound quality of mono anchors and compatibility with mainstream external sound cards. The sound network stereo collection and high sound quality technology can greatly improve the sound quality of anchors using sound cards and enhance the attraction of live broadcasting rooms. At present, it has been adapted to mainstream sound cards in the market. "), "selected": false, "index": 3, "soundType": 3]] {
