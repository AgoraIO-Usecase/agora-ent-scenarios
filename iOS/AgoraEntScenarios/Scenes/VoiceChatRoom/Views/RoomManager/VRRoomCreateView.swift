...
public class VRRoomCreateView: UIImageView {
    ...
    override init(frame: CGRect) {
        ...
        createRoom.set(image:UIImage.sceneImage(name: "add", bundleName: "VoiceChatRoomResource"), title: LanguageManager.localValue(key: "Create Room"), titlePosition: .right, additionalSpacing: 7, state: .normal)
