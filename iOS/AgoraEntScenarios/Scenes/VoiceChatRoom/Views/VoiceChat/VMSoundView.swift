...
class VMSoundView: UIView {
    ...
    private func layoutUI() {
        ...
        usageLabel.text = "CUS Use".voice_localized()
    ...
    private func setSoundEffect(_ effect: Int) {
        ...
        case 1:
            ...
            iconImgs = images[0]
            typeStr = "Social Chat".voice_localized()
        case 2:
            ...
            iconImgs = images[1]
            typeStr = "Karaoke".voice_localized()
        case 3:
            ...
            iconImgs = images[2]
            typeStr = "Gaming Buddy".voice_localized()
        default:
            ...
            iconImgs = images[3]
            typeStr = "Professional Podcaster".voice_localized()
        }
