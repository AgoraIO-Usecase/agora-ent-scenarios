...
//    private let spatialSound = VRSpatialSoundViewController()
    ...
    private lazy var container: VoiceRoomPageContainer = {
        VoiceRoomPageContainer(frame: CGRect(x: 0, y: ZNavgationHeight, width: ScreenWidth, height: ScreenHeight - ZNavgationHeight - 10 - CGFloat(ZBottombarHeight) - 30), viewControllers: [self.all]).backgroundColor(.clear)
    }()
    ...
    override public func viewDidLoad() {
        ...
        self.view.addSubViews([background, container, create])
