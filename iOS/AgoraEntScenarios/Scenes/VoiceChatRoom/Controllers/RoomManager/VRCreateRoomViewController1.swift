...
final class VRCreateRoomViewController1: VRBaseViewController {
    ...
    lazy var container: VRCreateRoomView = .init(frame: CGRect(x: 0, y: 10, width: ScreenWidth, height: 340))
...
extension VRCreateRoomViewController1 {
