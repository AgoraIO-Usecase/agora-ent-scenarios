...
public extension UIView {
    ...
    */
    func hideToast() {
        guard let activeToast = self.activeToasts.firstObject as? UIView else { return }
        self.hideToast(activeToast)
    }
    ...
    func hideToast(_ toast: UIView) {
        guard self.activeToasts.contains(toast) else { return }
    ...
    */
    func hideAllToasts(includeActivity: Bool = false, clearQueue: Bool = true) {
        ...
        self.activeToasts.compactMap { $0 as? UIView }
