...
public let voiceChatBundle = Bundle(path: Bundle.main.path(forResource: "VoiceChatRoomResource", ofType: "bundle") ?? "") ?? Bundle.main
...
public extension Bundle {
    static var voiceRoomBundle: Bundle { voiceChatBundle }
