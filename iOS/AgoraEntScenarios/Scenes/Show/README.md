...
商汤
  ...
  > 
  >   ![xxx](https://fullapp.oss-cn-beijing.aliyuncs.com/ent-scenarios/readme/image/show/ent_show_sense1.jpg)
  >  
  >   <mark> 注意：以上只包含基础美颜功能。</mark>  
  >   如果需要贴纸或者风格效果，需要联系商汤获取，同样将资源放到SenseLib指定路径下即可，如图：
  > 
  >   ![xxx](https://fullapp.oss-cn-beijing.aliyuncs.com/ent-scenarios/readme/image/show/ent_show_sense2.jpg)
  >   ![xxx](https://fullapp.oss-cn-beijing.aliyuncs.com/ent-scenarios/readme/image/show/ent_show_sense3.jpg)
  >  
  >
  > - 2.将申请到的商汤的license文件命名为“SENSEME.lic”并放入SenseLib指定路径下即可，如图：
  > 
  >   ![xxx](https://fullapp.oss-cn-beijing.aliyuncs.com/ent-scenarios/readme/image/show/ent_show_sense4.jpg)
  >   
  > - 3.注意事项：
  > 
  ...
  >  
  >   <mark> 注意：默认不放入资源只包含基础美颜功能。</mark>  
  >   如果需要贴纸或者风格效果，需要联系相芯获取，同样将资源放到FULib/Resources路径下即可。如图：
  > 
  >   ![xxx](https://fullapp.oss-cn-beijing.aliyuncs.com/ent-scenarios/readme/image/show/ent_show_fu1.jpg)
  >  
  >
  > - 2.将申请到的相芯的license文件命名为“authpack.h”并拖入FULib路径下 如图：
  > 
  >   ![xxx](https://fullapp.oss-cn-beijing.aliyuncs.com/ent-scenarios/readme/image/show/ent_show_fu2.jpg)
  >   
  > - 3.注意事项：
  > 
  ...
  > 
  >   ![xxx](https://fullapp.oss-cn-beijing.aliyuncs.com/ent-scenarios/readme/image/show/ent_show_byte1.jpg)
  >  
  >   <mark> 注意：以上只包含基础美颜功能。</mark>  
  >   如果需要贴纸或者风格效果，需要联系相芯获取，同样将资源放到ByteEffectLib/Resources路径下即可。如图：
  > 
  >   ![xxx](https://fullapp.oss-cn-beijing.aliyuncs.com/ent-scenarios/readme/image/show/ent_show_byte2.jpg)
  >  
  >
  > - 2.将申请到的火山的license文件“LicenseBag.bundle”拖入ByteEffectLib/Resources路径下,并修改Config.h文件中的LICENSE_NAME 如图：
  > 
  >   ![xxx](https://fullapp.oss-cn-beijing.aliyuncs.com/ent-scenarios/readme/image/show/ent_show_byte3.jpg)
  >   ![xxx](https://fullapp.oss-cn-beijing.aliyuncs.com/ent-scenarios/readme/image/show/ent_show_byte4.jpg)
  >   
  > - 3.注意事项：
  > 
