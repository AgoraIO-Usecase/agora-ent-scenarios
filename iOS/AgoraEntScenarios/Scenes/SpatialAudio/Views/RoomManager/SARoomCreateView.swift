...
public class SARoomCreateView: UIImageView {
    var action: (() -> Void)?
    ...
    override init(frame: CGRect) {
        ...
        createRoom.set(image:UIImage.sceneImage(name: "voice_add", bundleName: "SpatialAudioResource"), title: "spatial_voice_create_room".spatial_localized(), titlePosition: .right, additionalSpacing: 7, state: .normal)
        createRoom.setBackgroundImage(UIImage.sceneImage(name: "create_room", bundleName: "SpatialAudioResource"), for: .normal)
...
extension UIView {
    @discardableResult
    func setSAGradient(_ colors: [UIColor], _ points: [CGPoint]) -> Self {
