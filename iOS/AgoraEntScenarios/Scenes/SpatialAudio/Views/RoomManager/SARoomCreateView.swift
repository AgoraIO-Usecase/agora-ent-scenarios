...
public class SARoomCreateView: UIImageView {
    ...
    override init(frame: CGRect) {
        ...
        createRoom.set(image:UIImage.sceneImage(name: "add", bundleName: "VoiceChatRoomResource"), title: sceneLocalized( "Create Room"), titlePosition: .right, additionalSpacing: 7, state: .normal)
