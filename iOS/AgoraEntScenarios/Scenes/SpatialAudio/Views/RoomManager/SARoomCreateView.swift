...
public class SARoomCreateView: UIImageView {
    ...
    override init(frame: CGRect) {
        ...
        createRoom.set(image:UIImage.sceneImage(name: "add", bundleName: "VoiceChatRoomResource"), title: "spatial_voice_create_room".localized_spatial(), titlePosition: .right, additionalSpacing: 7, state: .normal)
