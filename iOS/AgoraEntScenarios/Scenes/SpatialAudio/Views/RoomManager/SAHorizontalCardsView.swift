...
@objc public protocol SAHorizontalCardsDataSource: NSObjectProtocol {
...
@objc public protocol SAHorizontalCardsDelegate: NSObjectProtocol {
...
public class SAHorizontalCardsView: UIView, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    public weak var dataSource: SAHorizontalCardsDataSource?

    public weak var delegate: SAHorizontalCardsDelegate?
    ...
    private func initCollectionView() {
        ...
        collectionView.register(SAHorizontalCardCell.self, forCellWithReuseIdentifier: reuseIdentifier)
    ...
    public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: reuseIdentifier, for: indexPath) as! SAHorizontalCardCell
...
public extension SAHorizontalCardsView {
