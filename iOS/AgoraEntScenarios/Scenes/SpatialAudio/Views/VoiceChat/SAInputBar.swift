...
public class SAInputBar: UIView, UITextViewDelegate {
    ...
    @objc private func keyboardWillHide(notification: Notification) {
        ...
        let emoji = SAEmojiListView(frame: CGRect(x: 0, y: inputField.frame.maxY, width: ScreenWidth, height: keyboardHeight)).tag(124)
        self.emoji = emoji
    ...
    func convertText(text: NSAttributedString?, key: String) -> NSAttributedString {
        ...
        attachment.image = UIImage.sceneImage(name: key)
