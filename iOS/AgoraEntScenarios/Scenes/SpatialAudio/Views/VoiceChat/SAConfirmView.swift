...
class SAConfirmView: UIView {
    ...
    func layoutUI() {
        ...
        titleLabel.text = "Prompt".spatial_localized()
        ...
        contentLabel.text = type == .addbot ? "Add Bot".spatial_localized() : "Exit Room".spatial_localized()
        ...
        canBtn.setTitle("Cancel".spatial_localized(), for: .normal)
        ...
        subBtn.setTitle("Submit".spatial_localized(), for: .normal)
