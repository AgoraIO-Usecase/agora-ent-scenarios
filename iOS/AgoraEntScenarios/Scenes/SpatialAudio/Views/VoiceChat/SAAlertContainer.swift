...
public class SAAlertContainer: UIView {
    lazy var indicator: UIImageView = .init(frame: CGRect(x: ScreenWidth / 2.0 - 19, y: 6, width: 38, height: 3)).image(UIImage.sceneImage(name: "pop_indicator")!)
