    ...
    public var micInfo: SARoomMic? {
        didSet {
            ...
            if m_type == -1 {
                ...
                lockBtn.setTitle("spatial_voice_unblock".localized_spatial(), for: .normal)
...
//                micView.setState(.forbidden)
                addView.image = UIImage.sceneImage(name:"icons／solid／lock")
                lockBtn.setTitle("spatial_voice_unblock".localized_spatial(), for: .normal)
                muteBtn.setTitle("spatial_voice_unmute".localized_spatial(), for: .normal)
                inviteBtn.setTitleColor(UIColor.HexColor(hex: 0x979cbb, alpha: 1), for: .normal)
                inviteBtn.isUserInteractionEnabled = false
                nameLabel.text = username
            } else if m_type == 1 {
...
//                micView.setVolume(100)
                // micView.isHidden = false
                inviteBtn.setTitle("spatial_voice_kick_micick".localized_spatial(), for: .normal)
            } else if m_type == 2 {
                iconView.sd_setImage(with: URL(string: iconStr), placeholderImage: nil)
...
//                micView.setState(.forbidden)
//                micView.isHidden = false
                inviteBtn.setTitle(micInfo?.member != nil ? "spatial_voice_kick_mic".localized_spatial() : "spatial_voice_invite".localized_spatial(), for: .normal)
                muteBtn.setTitle("spatial_voice_unmute".localized_spatial(), for: .normal)
            }
    ...
    private func layoutUI() {
        ...
        roleBtn.setTitle("spatial_voice_host".localized_spatial(), for: .normal)
        ...
        inviteBtn.setTitle("spatial_voice_invite".localized_spatial(), for: .normal)
...
//        micView.isHidden = true
        ...
        muteBtn.setTitle("spatial_voice_mute".localized_spatial(), for: .normal)
        ...
        lockBtn.setTitle("spatial_voice_block".localized_spatial(), for: .normal)
