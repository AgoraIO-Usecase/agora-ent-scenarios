...
public class SAChatView: UIView, UITableViewDelegate, UITableViewDataSource {
    ...
    lazy var emitter: SAPraiseEmitterView = .init(frame: CGRect(x: ScreenWidth - 80, y: -20, width: 80, height: self.frame.height - 20))
    ...
    override public init(frame: CGRect) {
        ...
        likeView.setImage(UIImage.sceneImage(name:"unlike"), for: .normal)
...
public extension SAChatView {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        var cell = tableView.dequeueReusableCell(withIdentifier: "VoiceRoomChatCell") as? SAChatCell
        if cell == nil {
            cell = SAChatCell(style: .default, reuseIdentifier: "VoiceRoomChatCell")
        }
