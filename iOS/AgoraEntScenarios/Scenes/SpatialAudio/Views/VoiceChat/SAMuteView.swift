...
public enum SAMUTE_ACTION {
    case unmute // unmute自己
    case mute // mute自己
    case leave // 下麦
}

class SAMuteView: UIView {
...
//                micView.setState(.forbidden)
    ...
    var resBlock: ((SAMUTE_ACTION) -> Void)?
    ...
    private func layoutUI() {
        ...
        bgView.backgroundColor = UIColor(hex: "0xdad9e9")
...
//        micView.isHidden = true
        ...
        leaveBtn.setTitle("spatial_voice_off_stage".localized_spatial(), for: .normal)
