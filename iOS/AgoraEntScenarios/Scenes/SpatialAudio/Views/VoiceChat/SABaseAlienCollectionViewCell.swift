...
class SABaseAlienCollectionViewCell: UICollectionViewCell {
    private var cornerView: UIView = .init()
    private var blueAlienView: SABaseRtcUserView = .init()
    private var redAlienView: SABaseRtcUserView = .init()
    ...
    public var cellType: SABaseAlienCellType = .AgoraChatRoomBaseUserCellTypeNonActived {
        didSet {
    ...
    public var activeVBlock: ((SABaseUserCellType) -> Void)?
