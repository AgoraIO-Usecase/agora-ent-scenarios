...
class SANoticeView: UIView {
    ...
    var noticeStr: String = "" {
        didSet {
            let notice = noticeStr.count == 0 ? "spatial_voice_welcome".spatial_localized() : noticeStr
            tv.text = notice
    ...
    func layoutUI() {
        ...
        subBtn.setTitle("spatial_voice_post".spatial_localized(), for: .normal)
        ...
        titleLabel.text = "spatial_voice_notice".spatial_localized()
        titleLabel.textColor = .black
        titleLabel.font = UIFont.systemFont(ofSize: 16)
        addSubview(titleLabel)

        tv.frame = CGRect(x: 10, y: 60, width: ScreenWidth - 20, height: 160)
        tv.text = "spatial_voice_welcome".spatial_localized()
        ...
        editBtn.setTitle("spatial_voice_edit".spatial_localized(), for: .normal)
...
extension SANoticeView: UITextViewDelegate {
...
extension UITextView {
    func sa_setPlaceholder(text: String) {
