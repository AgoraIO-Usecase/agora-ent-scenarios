...
fileprivate struct SACornerPoint {
    var center: CGPoint
...
public extension SAPopTip {
    class func pathWith(rect: CGRect, frame: CGRect, direction: SAPopTipDirection, arrowSize: CGSize, arrowPosition: CGPoint, arrowRadius: CGFloat, borderWidth: CGFloat = 0, radius: CGFloat = 0) -> UIBezierPath {
        ...
        case .down:
            ...
            // 2: Arrow vertex arc
            if let cornerPoint = roundCornerCircleCenter(start: arrowStartPoint, vertex: arrowVertex, end: arrowEndPoint, radius: arrowRadius) {
    ...
    private class func roundCornerCircleCenter(start: CGPoint, vertex: CGPoint, end: CGPoint, radius: CGFloat) -> SACornerPoint? {
        ...
        return SACornerPoint(center: CGPoint(x: intersectionX, y: intersectionY),
