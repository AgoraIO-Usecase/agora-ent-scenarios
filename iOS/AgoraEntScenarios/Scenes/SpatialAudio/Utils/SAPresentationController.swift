...
public final class SAPresentationController: UIPresentationController {
    /// present配置
    private let component: SAPresentedViewComponent
    ...
    /// pan手势方向
    private var panDirection: SAPanDismissDirection {
...
extension SAPresentationController {
