...
public class SAPasswordAlert: UIView {
    ...
    lazy var title: UILabel = .init(frame: CGRect(x: 30, y: 30, width: self.frame.width - 60, height: 20)).textColor(.darkText).font(.systemFont(ofSize: 16, weight: .regular)).textAlignment(.center).text(sceneLocalized( "Enter 4 Digit Password"))
