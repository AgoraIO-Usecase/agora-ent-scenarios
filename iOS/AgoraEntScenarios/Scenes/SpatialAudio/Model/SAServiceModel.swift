...
class SABaseRoomModel: NSObject, Convertible  {
    var roomName: String?
...
class SAVoiceUserModel: NSObject, Convertible  {
    var uid: String?
    var chatUid: String?
    var name: String?
    var portrait: String?
...
class SAUserRankModel: NSObject, Convertible  {
    var name: String?
    var portrait: String = ""
    var amount: Int = 0
    override public required init() {}
...
class SADetailModel: SABaseRoomModel {
    
    var owner: SAUserModel?
    var roomId: String = ""
