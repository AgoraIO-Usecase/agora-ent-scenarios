...
class RoomListNavigationBar: UIView {
    ...
    func setLeftButtonTarget(_ target: AnyObject, action: Selector, image: UIImage? = UIImage.sceneImage(name: "navi_back"), title: String? = nil ) {
        self.leftItems = nil
...
extension RoomListNavigationBar {
