...
public struct CloudGameDetailInfo: Codable {
    ...
    public var actions: [CloudGameActions]?
    enum CodingKeys: String, CodingKey {
        case gameId = "game_id"
        case vendorGameId = "vendor_game_id"
        case name, vendor, thumbnail, introduce, gifts, instrunct, feature, actions
    }
}
...
public struct CloudGameActions: Codable {
    public var command: [String]?
    public var icon: String
    public var index: Int
    enum CodingKeys: String, CodingKey {
        case command, icon, index
    }
}
