...
- (void)setUpView {
    ...
    self.picImgView.image = [UIImage dhc_sceneImageWith:@"online_temp_icon" ];
...
//    [self addSubview:self.typeLabel];
    ...
    [self.deleteBtn setImage:[UIImage dhc_sceneImageWith:@"ktv_delete_icon" ] forState:UIControlStateNormal];
    ...
    [self.sortBtn setImage:[UIImage dhc_sceneImageWith:@"ktv_sort_icon" ] forState:UIControlStateNormal];
    ...
    [self.singingBtn setImage:[UIImage dhc_sceneImageWith:@"ktv_singing_icon" ] forState:UIControlStateNormal];
