...
- (void)setupView {
    ...
    self.lockImgView.image = [UIImage dhc_sceneImageWith:@"suo" ];
    ...
    self.onListIconView.image = [UIImage dhc_sceneImageWith:@"online_list_countIcon"  ];
...
- (void)setListModel:(VLRoomListModel *)listModel {
    ...
    self.countLabel.text = [NSString stringWithFormat:@"%@%@",listModel.roomPeopleNum, DHCLocalizedString(@"ktv_people")];
}
