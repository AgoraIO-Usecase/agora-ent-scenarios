...
public typealias SRLyricCallback = ((String?) -> Void)
public typealias SRLoadMusicCallback = ((AgoraMusicContentCenterPreloadStatus, NSInteger) -> Void)
public typealias ISRSwitchRoleStateListener = (SRSwitchRoleState, SRSwitchRoleFailReason) -> Void
public typealias SRMusicChartCallBacks = (String, AgoraMusicContentCenterStatusCode, [AgoraMusicChartInfo]?) -> Void
public typealias SRMusicResultCallBacks = (String, AgoraMusicContentCenterStatusCode, AgoraMusicCollection) -> Void
public typealias SRJoinExChannelCallBack = ((Bool, SRJoinChorusFailReason?)-> Void)
...
@objc public protocol SRApiDelegate: NSObjectProtocol {
     ...
     */
    func fetchMusicCharts(completion:@escaping SRMusicChartCallBacks)
    ...
    */
    func searchMusic(musicChartId: Int,
                     ...
                     pageSize: Int,
                     jsonOption: String,
                     completion:@escaping SRMusicResultCallBacks)
    ...
    */
    ...
    func switchSingerRole(newRole: SRSingRole, onSwitchRoleState:@escaping ISRSwitchRoleStateListener)
