...
@implementation SRDebugViewController

- (NSArray*)dataArray {
    return [SRDebugInfo debugDataArray];
}
...
- (void)viewDidLoad {
    ...
    [cleanDumpBtn setTitle:SRLocalizedString(@"sr_clear_dump") forState:UIControlStateNormal];
    ...
    [cleanBtn setTitle:SRLocalizedString(@"sr_clear_log") forState:UIControlStateNormal];
    ...
    [exportBtn setTitle:SRLocalizedString(@"sr_export_log") forState:UIControlStateNormal];
...
- (UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.textLabel.text = [self.dataArray objectAtIndex:indexPath.row][rTitleKey];
    cell.accessoryType = [SRDebugInfo getSelectedStatusForKey:cell.textLabel.text] ? UITableViewCellAccessoryCheckmark : UITableViewCellAccessoryNone;
    return cell;
}

- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    NSDictionary* rowDic = [self.dataArray objectAtIndex:indexPath.row];
    NSString* key = rowDic[rTitleKey];
