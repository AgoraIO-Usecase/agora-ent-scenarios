...
- (void)setupView {
    ...
    warImgView.image = [UIImage sceneImageWithName:@"zhuyi" bundleName:@"SRResource"];
    ...
    [randomBtn setImage:[UIImage sceneImageWithName:@"online_create_randomIcon" bundleName:@"SRResource"] forState:UIControlStateNormal];
    ...
    [self.enBtn setBackgroundImage:[UIImage sceneImageWithName:@"guan" bundleName:@"SRResource"] forState:UIControlStateNormal];
    [self.enBtn setBackgroundImage:[UIImage sceneImageWithName:@"open" bundleName:@"SRResource"] forState:UIControlStateSelected];
    ...
    [createBtn setBackgroundImage:[UIImage sceneImageWithName:@"createRoomBtn" bundleName:@"SRResource"] forState:UIControlStateNormal];
...
- (void)randomBtnClickEvent {
    ...
    self.iconImgView.image = [UIImage sceneImageWithName: iconName bundleName:@"SRResource"];
}
