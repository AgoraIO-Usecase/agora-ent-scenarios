...
- (void)setUpView {
    ...
    [self.chooseBtn setTitle:SRLocalizedString(@"sr_room_choose_song") forState:UIControlStateNormal];
...
- (void)setSongItemModel:(VLSRSongItmModel *)songItemModel {
    ...
    if (songItemModel.ifChoosed) {
        ...
        [self.chooseBtn setTitle:SRLocalizedString(@"sr_room_chosen_song_list") forState:UIControlStateNormal];
