...
- (void)setupView {
    ...
    self.roomerImgView.image = [UIImage sceneImageWithName:@"ktv_roomOwner_icon" bundleName:@"SRResource"];
    ...
    self.muteImgView.image = [UIImage sceneImageWithName:@"ktv_self_seatMute" bundleName:@"SRResource"];
    ...
    [self.singingBtn setImage:[UIImage sceneImageWithName:@"ktv_seatsinging_icon" bundleName:@"SRResource"] forState:UIControlStateNormal];
...
//    self.singingBtn.imagePosition = QMUIButtonImagePositionLeft;
    ...
    [self.joinChorusBtn setImage:[UIImage sceneImageWithName:@"ic_hc" bundleName:@"SRResource"] forState:UIControlStateNormal];
