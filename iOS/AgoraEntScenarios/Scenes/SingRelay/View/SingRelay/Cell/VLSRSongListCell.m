...
- (void)setUpView {
    ...
    self.picImgView.image = [UIImage sr_sceneImageWithName:@"online_temp_icon" ];
...
//    [self addSubview:self.typeLabel];
    ...
    [self.deleteBtn setImage:[UIImage sr_sceneImageWithName:@"ktv_delete_icon" ] forState:UIControlStateNormal];
    ...
    [self.sortBtn setImage:[UIImage sr_sceneImageWithName:@"ktv_sort_icon" ] forState:UIControlStateNormal];
    ...
    [self.singingBtn setImage:[UIImage sr_sceneImageWithName:@"ktv_singing_icon" ] forState:UIControlStateNormal];
