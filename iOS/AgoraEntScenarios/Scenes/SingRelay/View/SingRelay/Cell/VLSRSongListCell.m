...
@implementation VLSRSongListCell
...
- (void)setUpView {
    ...
    self.picImgView.image = [UIImage sceneImageWithName:@"online_temp_icon" bundleName:@"SRResource"];
...
//    [self addSubview:self.typeLabel];
    ...
    [self.deleteBtn setImage:[UIImage sceneImageWithName:@"ktv_delete_icon" bundleName:@"SRResource"] forState:UIControlStateNormal];
    ...
    [self.sortBtn setImage:[UIImage sceneImageWithName:@"ktv_sort_icon" bundleName:@"SRResource"] forState:UIControlStateNormal];
    ...
    [self.singingBtn setImage:[UIImage sceneImageWithName:@"ktv_singing_icon" bundleName:@"SRResource"] forState:UIControlStateNormal];
...
- (void)setSelSongModel:(VLSRRoomSelSongModel *)selSongModel {
    ...
    if (selSongModel.status == VLSRSongPlayStatusIdle) {
    ...
    }else if (selSongModel.status == VLSRSongPlayStatusPlaying){
