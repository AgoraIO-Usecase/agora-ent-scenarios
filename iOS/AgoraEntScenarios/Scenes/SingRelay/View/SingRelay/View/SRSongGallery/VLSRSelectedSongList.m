...
#import "VLSRSearchSongResultView.h"
...
VLSRSearchSongResultViewDelegate,
UITextFieldDelegate
>

@property(nonatomic, weak) id <VLSRSelectedSongListDelegate>delegate;
@property (nonatomic, strong) UIView *bgView;
@property (nonatomic, strong) UITextField *searchTF;
@property (nonatomic, strong) VLHotSpotBtn *cancelButton;
@property (nonatomic, strong) JXCategoryTitleView *categoryView;
@property (nonatomic, strong) JXCategoryListContainerView *listContainerView;
@property (nonatomic, strong) VLSRSearchSongResultView *resultView;
...
@implementation VLSRSelectedSongList
...
- (instancetype)initWithFrame:(CGRect)frame
                 withDelegate:(id<VLSRSelectedSongListDelegate>)delegate
...
- (void)setupView{
    ...
    searchIcon.image = [UIImage sceneImageWithName:@"ktv_search_icon" bundleName:@"SRResource"];
    ...
    [clearButton setImage:[UIImage sceneImageWithName:@"ktv_search_clearIcon" bundleName:@"SRResource"]
    ...
    //搜索结果
    self.resultView = [[VLSRSearchSongResultView alloc]initWithFrame:CGRectMake(0, bgView.bottom+4, SCREEN_WIDTH, self.height-bgView.bottom-4)
                                                      withDelegate:self
...
-(void)updateUIWithSelSongsArray:(NSArray *)array {
    VLSRSelectSongTableItemView *selView = nil;
    for(VLSRSelectSongTableItemView *view in self.selSongViews){
...
- (id<JXCategoryListContentViewDelegate>)listContainerView:(JXCategoryListContainerView *)listContainerView initListForIndex:(NSInteger)index {
    VLSRSelectSongTableItemView *selSongView = [[VLSRSelectSongTableItemView alloc] initWithFrame:CGRectMake(0, 0, 0, 0)
