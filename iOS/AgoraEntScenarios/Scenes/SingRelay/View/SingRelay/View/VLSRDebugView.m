...
-(void)layoutUI {
    ...
    titleLabel.text = SRLocalizedString(@"Debug Settings");
    ...
    headLabel.text = SRLocalizedString(@"sr_dump");
    ...
    logLabel.text = SRLocalizedString(@"sr_export_log");
    ...
    [exportLogBtn setTitle:SRLocalizedString(@"sr_debug_confirm") forState:UIControlStateNormal];
    ...
    clearDumpLabel.text = SRLocalizedString(@"sr_clear_dump");
    ...
    [clearDumpBtn setTitle:SRLocalizedString(@"sr_debug_confirm") forState:UIControlStateNormal];
    ...
    clearLogLabel.text = SRLocalizedString(@"sr_clear_log");
    ...
    [clearLogBtn setTitle:SRLocalizedString(@"sr_debug_confirm") forState:UIControlStateNormal];
    ...
    NSAttributedString *keyPlaceholder = [[NSAttributedString alloc] initWithString:SRLocalizedString(@"sr_input_key") attributes:attributes];
    ...
    NSAttributedString *valuePlaceholder = [[NSAttributedString alloc] initWithString:SRLocalizedString(@"sr_input_value") attributes:attributes];
    ...
    [setParamsBtn setTitle:SRLocalizedString(@"sr_set_params") forState:UIControlStateNormal];
