...
//                                                   ballSize:22];
    ...
    circleImgView.image = [UIImage sceneImageWithName:@"ktv_circle_bgIcon" bundleName:@"SRResource"];
    ...
    self.rotateImgView.image = [UIImage sceneImageWithName:@"ktv_soundEffert_icon" bundleName:@"SRResource"];
