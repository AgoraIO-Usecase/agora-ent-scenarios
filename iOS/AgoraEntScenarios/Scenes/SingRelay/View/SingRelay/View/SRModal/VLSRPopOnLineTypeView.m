...
@property(nonatomic, weak) id <VLSRPopOnLineTypeViewDelegate>delegate;
...
@implementation VLSRPopOnLineTypeView
...
- (void)setupView {
    ...
    [backBtn setImage:[UIImage sceneImageWithName:@"ktv_back_whiteIcon" bundleName:@"SRResource"] forState:UIControlStateNormal];
    ...
    [audioBtn setImage:[UIImage sceneImageWithName:@"KTV_onLineType_audionIcon" bundleName:@"SRResource"] forState:UIControlStateNormal];
    ...
    self.audioSelImgView.image = [UIImage sceneImageWithName:@"ktv_selbg_icon" bundleName:@"SRResource"];
    self.audioSelImgView.hidden = YES;
    ...
    [audioBtn setImage:[UIImage sceneImageWithName:@"KTV_onLineType_videoIcon" bundleName:@"SRResource"] forState:UIControlStateNormal];
    ...
    self.videoSelImgView.image = [UIImage sceneImageWithName:@"ktv_selbg_icon" bundleName:@"SRResource"];
