...
@interface VLSRPopScoreView ()

@property(nonatomic, weak) id <VLSRPopScoreViewDelegate>delegate;
...
@implementation VLSRPopScoreView
...
- (void)configScore:(int)score {
    ...
    _scoreImgView.image = [UIImage sceneImageWithName:imageNamed bundleName:@"SRResource"];
}
...
- (UIImageView *)starImageView {
    if (!_starImageView) {
        ...
        _starImageView.image = [UIImage sceneImageWithName:@"ktv_score_star" bundleName:@"SRResource"];
    }
...
- (UIImageView *)scoreImgView {
    if (!_scoreImgView) {
        ...
        _scoreImgView.image = [UIImage sceneImageWithName:@"ktv_score_S" bundleName:@"SRResource"];
    }
...
- (UIImageView *)circleLightImageView {
    if (!_circleLightImageView) {
        ...
        _circleLightImageView.image = [UIImage sceneImageWithName:@"ktv_score_topPart" bundleName:@"SRResource"];
    }
...
- (UIImageView *)circleImageView {
    if (!_circleImageView) {
        ...
        _circleImageView.image = [UIImage sceneImageWithName:@"ktv_score_bottomPart" bundleName:@"SRResource"];
    }
