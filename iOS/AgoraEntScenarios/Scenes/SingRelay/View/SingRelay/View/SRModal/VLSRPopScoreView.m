...
- (void)configScore:(int)score {
    ...
    _scoreImgView.image = [UIImage sr_sceneImageWithName:imageNamed ];
}
...
- (UIImageView *)starImageView {
    if (!_starImageView) {
        ...
        _starImageView.image = [UIImage sr_sceneImageWithName:@"ktv_score_star" ];
    }
...
- (UIImageView *)scoreImgView {
    if (!_scoreImgView) {
        ...
        _scoreImgView.image = [UIImage sr_sceneImageWithName:@"ktv_score_S" ];
    }
...
- (UIImageView *)circleLightImageView {
    if (!_circleLightImageView) {
        ...
        _circleLightImageView.image = [UIImage sr_sceneImageWithName:@"ktv_score_topPart" ];
    }
...
- (UIImageView *)circleImageView {
    if (!_circleImageView) {
        ...
        _circleImageView.image = [UIImage sr_sceneImageWithName:@"ktv_score_bottomPart" ];
    }
