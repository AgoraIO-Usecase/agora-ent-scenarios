...
- (void)setupView {
    ...
    self.selIcon.image = [UIImage sceneImageWithName:@"SR_selbg_icon" bundleName:@"SRResource"];
    [self.contentView addSubview:self.selIcon];
}

- (void)setSelBgModel:(VLSRSelBgModel *)selBgModel {
    _selBgModel = selBgModel;
    self.picImgView.image = [UIImage sceneImageWithName:selBgModel.imageName bundleName:@"SRResource"];
