...
@property(nonatomic, weak) id <VLSRDropOnLineViewDelegate>delegate;
@property (nonatomic, strong) UIImageView *avatarImgView;
@property (nonatomic, strong) UILabel *nickNameLabel;

@end

@implementation VLSRDropOnLineView
...
- (void)setupView {
    ...
    [dropLineBtn setTitle:SRLocalizedString(@"sr_room_seat_off") forState:UIControlStateNormal];
...
- (void)setSeatModel:(VLSRRoomSeatModel *)seatModel {
