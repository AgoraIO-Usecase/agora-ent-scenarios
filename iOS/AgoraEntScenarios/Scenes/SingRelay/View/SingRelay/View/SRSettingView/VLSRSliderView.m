...
- (UISlider *)sliderView {
    if (!_sliderView) {
        ...
        [_sliderView setThumbImage:[UIImage sceneImageWithName:@"icon_SR_slider" bundleName:@"SRResource"] forState:UIControlStateNormal];
        [_sliderView setThumbImage:[UIImage sceneImageWithName:@"icon_SR_slider" bundleName:@"SRResource"] forState:UIControlStateHighlighted];
