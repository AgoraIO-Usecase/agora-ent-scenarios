...
- (UISlider *)sliderView {
    if (!_sliderView) {
        ...
        [_sliderView setThumbImage:[UIImage sr_sceneImageWithName:@"icon_SR_slider" ] forState:UIControlStateNormal];
        [_sliderView setThumbImage:[UIImage sr_sceneImageWithName:@"icon_SR_slider" ] forState:UIControlStateHighlighted];
