...
- (void)setModel:(VLSRKindsModel *)model {
    _model = model;
    _cLabel.text = _model.title;
    _cImageView.image = [UIImage sceneImageWithName:_model.imageName bundleName:@"SRResource"];
    if (_model.selected) {
