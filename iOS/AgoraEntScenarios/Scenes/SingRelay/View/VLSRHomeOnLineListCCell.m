...
- (void)setupView {
    ...
    self.lockImgView.image = [UIImage sceneImageWithName:@"suo" bundleName:@"SRResource"];
    ...
    self.onListIconView.image = [UIImage sceneImageWithName:@"online_list_countIcon" bundleName:@"SRResource"];
