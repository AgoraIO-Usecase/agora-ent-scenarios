...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
  //  VL(weakSelf);
    ...
    cell.bgImgView.image = [UIImage sceneImageWithName:[NSString stringWithFormat:@"create_bg_%li" ,indexPath.row % 5] bundleName:@"SRResource"];
...
- (UIButton *)createBtn {
    if (!_createBtn) {
        ...
        [_createBtn setBackgroundImage:[UIImage sceneImageWithName:@"create_room" bundleName:@"SRResource"] forState:UIControlStateNormal];
