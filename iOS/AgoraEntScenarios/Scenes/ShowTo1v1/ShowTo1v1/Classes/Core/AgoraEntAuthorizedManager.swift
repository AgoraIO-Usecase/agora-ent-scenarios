...
open class AgoraEntAuthorizedManager: NSObject {
    ...
    @objc class func showCameraAuthorizedFail(parent: UIViewController) {
        showAuthorizedFail(parent: parent, message: "authorized_camera_fail".showTo1v1Localization())
    }
    ...
    @objc class func showAuthorizedFail(parent: UIViewController, message: String) {
        ...
        let okAction = UIAlertAction(title: "authorized_ok".showTo1v1Localization() as String,
                                     style: .default) { action in
            UIApplication.shared.open(URL(string: UIApplication.openSettingsURLString)!)
        }
        let cancelAction = UIAlertAction(title: "authorized_cancel".showTo1v1Localization() as String,
                                         style: .cancel)
