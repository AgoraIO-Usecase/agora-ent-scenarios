...
extension TranscriptSubtitleMachine {
    func invokeAdd(_ machine: TranscriptSubtitleMachine, renderInfo: TranscriptSubtitleMachine.RenderInfo) {
        DispatchQueue.main.async { [weak self] in
            self?.delegate?.transcriptSubtitleMachine(machine, didAddRenderInfo: renderInfo)
        }
    }
    
    func invokeUpdate(_ machine: TranscriptSubtitleMachine, renderInfo: TranscriptSubtitleMachine.RenderInfo) {
        DispatchQueue.main.async { [weak self] in
